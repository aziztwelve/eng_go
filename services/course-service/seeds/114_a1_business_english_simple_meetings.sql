...
VALUES ('8dbc6351-972c-55d4-807a-378d2e576b8d', 'A1_BUSINESS_ENGLISH_SIMPLE_MEETINGS', 'Простые деловые встречи', 'Научитесь начинать простую встречу, высказывать идеи и завершать обсуждение.', '{"en":"Simple Meetings","ru":"Простые деловые встречи"}'::jsonb, '{"en":"Learn to start a simple meeting, share ideas, and end a discussion.","ru":"Научитесь начинать простую встречу, высказывать идеи и завершать обсуждение."}'::jsonb, 'en', 'A1', '', ARRAY['business_english']::text[], true, 114, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET title = EXCLUDED.title, description = EXCLUDED.description, title_i18n = EXCLUDED.title_i18n, description_i18n = EXCLUDED.description_i18n, motivation = EXCLUDED.motivation, is_published = EXCLUDED.is_published, sort_order = EXCLUDED.sort_order, updated_at = NOW();

INSERT INTO courses.lessons (id, module_id, title, description, title_i18n, description_i18n, order_index, created_at, updated_at)
VALUES ('6650bf91-5458-50f6-8e8d-85b6067881f5', NULL, 'Начало встречи', 'Научиться приветствовать участников и начинать простую деловую встречу.', '{"en":"Starting a Meeting","ru":"Начало встречи"}'::jsonb, '{"en":"Learn to greet participants and start a simple business meeting.","ru":"Научиться приветствовать участников и начинать простую деловую встречу."}'::jsonb, 0, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET title = EXCLUDED.title, description = EXCLUDED.description, title_i18n = EXCLUDED.title_i18n, description_i18n = EXCLUDED.description_i18n, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('430fb582-c2c3-5729-9a99-82f2ad550c8d', '6650bf91-5458-50f6-8e8d-85b6067881f5', 'match_pairs', 'Соедините пары', '{"en":"Match the pairs","ru":"Соедините пары"}'::jsonb, '{"instruction":"Соедините английские слова с переводом.","pairs":[{"id":"BESM_L1_MP_P1","left":"meeting","right":"встреча"},{"id":"BESM_L1_MP_P2","left":"start","right":"начинать"},{"id":"BESM_L1_MP_P3","left":"everyone","right":"все"},{"id":"BESM_L1_MP_P4","left":"Good morning","right":"Доброе утро"},{"id":"BESM_L1_MP_P5","left":"Please sit down","right":"Пожалуйста, садитесь"},{"id":"BESM_L1_MP_P6","left":"We are ready","right":"Мы готовы"},{"id":"BESM_L1_MP_P7","left":"Let us begin","right":"Давайте начнём"}]}'::jsonb, 0, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('3927d82e-9f12-534c-b949-8fc11b00f37a', '6650bf91-5458-50f6-8e8d-85b6067881f5', 'quiz', 'Проверьте себя', '{"en":"Check yourself","ru":"Проверьте себя"}'::jsonb, '{"explanation":"“Let us begin” clearly starts the meeting.","instruction":"Выберите правильный ответ.","options":[{"id":"BESM_L1_Q_A","is_correct":true,"text":"Let us begin."},{"id":"BESM_L1_Q_B","is_correct":false,"text":"Good night, everyone."},{"id":"BESM_L1_Q_C","is_correct":false,"text":"I am a meeting."}],"question":"What phrase can start a meeting?"}'::jsonb, 1, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('02e8d4f6-e189-54c0-8749-96edd36c6179', '6650bf91-5458-50f6-8e8d-85b6067881f5', 'translate', 'Переведите', '{"en":"Translate","ru":"Переведите"}'::jsonb, '{"correct_translation":"Let us begin the meeting.","instruction":"Соберите перевод.","source_language":"ru","source_text":"Давайте начнём встречу.","target_language":"en","word_bank":["meeting.","the","begin","us","Let"]}'::jsonb, 2, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('0abff549-13b5-5f3e-8309-c331838991b4', '6650bf91-5458-50f6-8e8d-85b6067881f5', 'fill_blank', 'Заполните пропуск', '{"en":"Fill the blank","ru":"Заполните пропуск"}'::jsonb, '{"correct_answer":"ready","instruction":"Выберите подходящее слово.","options":["ready","office","client"],"sentence_template":"We are ___."}'::jsonb, 3, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('55719a09-1b10-5500-ba11-ca75ef5741a6', '6650bf91-5458-50f6-8e8d-85b6067881f5', 'tap_words', 'Соберите фразу', '{"en":"Build the phrase","ru":"Соберите фразу"}'::jsonb, '{"correct_words":["Good","morning,","everyone."],"instruction":"Расставьте слова в правильном порядке.","word_bank":["morning,","Good","everyone."]}'::jsonb, 4, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('38f23831-a429-5acf-9f2f-b03118adea3d', '6650bf91-5458-50f6-8e8d-85b6067881f5', 'listening', 'Послушайте', '{"en":"Listen","ru":"Послушайте"}'::jsonb, '{"audio_text":"Good morning, everyone. Let us begin.","instruction":"Напишите услышанное.","language":"en"}'::jsonb, 5, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('6374ef39-e8bb-5571-ba8a-2929e3af4e01', '6650bf91-5458-50f6-8e8d-85b6067881f5', 'listening_shadowing', 'Повторите', '{"en":"Repeat","ru":"Повторите"}'::jsonb, '{"audio_text":"Good morning. Please sit down. We are ready to start.","instruction":"Запишите повтор.","language":"en","min_accuracy":0.7,"translation_hint":"Доброе утро. Пожалуйста, садитесь. Мы готовы начать."}'::jsonb, 6, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('28cda117-aee1-5f7a-a15e-21c94fc655e3', '6650bf91-5458-50f6-8e8d-85b6067881f5', 'story', 'История', '{"en":"Story","ru":"История"}'::jsonb, '{"instruction":"Прочитайте историю.","scenes":[{"character":"Manager","text":"Good morning, everyone.","translation":"Доброе утро, все.","type":"dialogue"},{"character":"Team","text":"Good morning.","translation":"Доброе утро.","type":"dialogue"},{"options":[{"is_correct":true,"text":"Let us begin the meeting."},{"is_correct":false,"text":"The meeting is a phone."}],"text":"What should the manager say next?","type":"choice"}],"title":"The Morning Meeting"}'::jsonb, 7, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('9733750d-ef01-5c76-b870-17414275d6e8', '6650bf91-5458-50f6-8e8d-85b6067881f5', 'choose_definition', 'Определение', '{"en":"Definition","ru":"Определение"}'::jsonb, '{"explanation":"A meeting is a planned time when people talk about work.","instruction":"Выберите значение.","language":"en","options":[{"id":"BESM_L1_D_A","is_correct":true,"text":"A planned time when people talk about work"},{"id":"BESM_L1_D_B","is_correct":false,"text":"A card with contact details"},{"id":"BESM_L1_D_C","is_correct":false,"text":"A department that helps customers"}],"word":"meeting"}'::jsonb, 8, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('c54cac80-395a-5846-9511-5e305390abb4', '6650bf91-5458-50f6-8e8d-85b6067881f5', 'listen_choose_word', 'Слово', '{"en":"Word","ru":"Слово"}'::jsonb, '{"audio_text":"Let us begin.","explanation":"The missing word is “begin.”","instruction":"Слушайте.","language":"en","options":[{"audio_text":"begin","id":"BESM_L1_LW_A","is_correct":true},{"audio_text":"client","id":"BESM_L1_LW_B","is_correct":false},{"audio_text":"card","id":"BESM_L1_LW_C","is_correct":false}],"sentence_template":"Let us ___."}'::jsonb, 9, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('173f98b3-4422-53af-a626-64ff601d6f6a', '6650bf91-5458-50f6-8e8d-85b6067881f5', 'missing_word', 'Впишите', '{"en":"Type","ru":"Впишите"}'::jsonb, '{"correct_answer":"ready","explanation":"The complete sentence is “We are ready.”","hint_prefix":"re","instruction":"Впишите пропущенное слово по подсказке.","sentence_template":"We are ___."}'::jsonb, 10, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('6b1a50d9-bebf-5a04-a6e7-3a6391f8f968', '6650bf91-5458-50f6-8e8d-85b6067881f5', 'match_pairs_voice', 'Звук', '{"en":"Sound","ru":"Звук"}'::jsonb, '{"explanation":"Match each meeting phrase you hear with the same written English phrase.","instruction":"Соедините звук.","language":"en","pairs":[{"audio_text":"meeting","id":"BESM_L1_VM_P1","text":"meeting"},{"audio_text":"Please sit down","id":"BESM_L1_VM_P2","text":"Please sit down"},{"audio_text":"Let us begin","id":"BESM_L1_VM_P3","text":"Let us begin"}]}'::jsonb, 11, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('36327837-2b2c-5ec0-9494-2f6d1ce4406a', '6650bf91-5458-50f6-8e8d-85b6067881f5', 'complete_chat', 'Диалог', '{"en":"Chat","ru":"Диалог"}'::jsonb, '{"answer_speaker":"You","dialogue":[{"speaker":"Manager","text":"Good morning, everyone. Are you ready?"}],"explanation":"“Yes, we are ready” naturally confirms that the team can begin.","instruction":"Ответьте.","options":[{"id":"BESM_L1_C_A","is_correct":true,"text":"Yes, we are ready."},{"id":"BESM_L1_C_B","is_correct":false,"text":"We are from morning."},{"id":"BESM_L1_C_C","is_correct":false,"text":"My meeting is a chair."}]}'::jsonb, 12, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();
...
INSERT INTO courses.lessons (id, module_id, title, description, title_i18n, description_i18n, order_index, created_at, updated_at)
VALUES ('d66a04d6-b209-5663-ba5d-6ac7efb26d54', NULL, 'Простые идеи и мнения', 'Научиться высказывать простую идею и соглашаться на встрече.', '{"en":"Simple Ideas and Opinions","ru":"Простые идеи и мнения"}'::jsonb, '{"en":"Learn to share a simple idea and agree during a meeting.","ru":"Научиться высказывать простую идею и соглашаться на встрече."}'::jsonb, 1, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET title = EXCLUDED.title, description = EXCLUDED.description, title_i18n = EXCLUDED.title_i18n, description_i18n = EXCLUDED.description_i18n, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('743697bb-b042-5c08-90a6-6154ae6f2393', 'd66a04d6-b209-5663-ba5d-6ac7efb26d54', 'match_pairs', 'Соедините пары', '{"en":"Match the pairs","ru":"Соедините пары"}'::jsonb, '{"instruction":"Соедините английские слова с переводом.","pairs":[{"id":"BESM_L2_MP_P1","left":"idea","right":"идея"},{"id":"BESM_L2_MP_P2","left":"plan","right":"план"},{"id":"BESM_L2_MP_P3","left":"I think","right":"Я думаю"},{"id":"BESM_L2_MP_P4","left":"I agree","right":"Я согласен"},{"id":"BESM_L2_MP_P5","left":"That is good","right":"Это хорошо"},{"id":"BESM_L2_MP_P6","left":"Yes, that is right","right":"Да, это верно"},{"id":"BESM_L2_MP_P7","left":"What do you think?","right":"Что вы думаете?"}]}'::jsonb, 0, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('ec44669d-3ad0-51ae-b022-f18ca02145a3', 'd66a04d6-b209-5663-ba5d-6ac7efb26d54', 'quiz', 'Проверьте себя', '{"en":"Check yourself","ru":"Проверьте себя"}'::jsonb, '{"explanation":"“I agree” means you have the same opinion.","instruction":"Выберите правильный ответ.","options":[{"id":"BESM_L2_Q_A","is_correct":true,"text":"I agree."},{"id":"BESM_L2_Q_B","is_correct":false,"text":"Let us sit."},{"id":"BESM_L2_Q_C","is_correct":false,"text":"I am a plan."}],"question":"Which phrase shows agreement?"}'::jsonb, 1, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('f45a9bac-39f5-5717-9a64-aac81dc077cf', 'd66a04d6-b209-5663-ba5d-6ac7efb26d54', 'translate', 'Переведите', '{"en":"Translate","ru":"Переведите"}'::jsonb, '{"correct_translation":"I agree with this plan.","instruction":"Соберите перевод.","source_language":"ru","source_text":"Я согласен с этим планом.","target_language":"en","word_bank":["plan.","this","with","agree","I"]}'::jsonb, 2, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('40ea719f-9083-5c93-a9ee-8881a59f0f42', 'd66a04d6-b209-5663-ba5d-6ac7efb26d54', 'fill_blank', 'Заполните пропуск', '{"en":"Fill the blank","ru":"Заполните пропуск"}'::jsonb, '{"correct_answer":"idea","instruction":"Выберите подходящее слово.","options":["idea","meeting","office"],"sentence_template":"That is a good ___."}'::jsonb, 3, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('45a6a14d-832f-51da-bc4d-b02b6213744d', 'd66a04d6-b209-5663-ba5d-6ac7efb26d54', 'tap_words', 'Соберите фразу', '{"en":"Build the phrase","ru":"Соберите фразу"}'::jsonb, '{"correct_words":["What","do","you","think?"],"instruction":"Расставьте слова в правильном порядке.","word_bank":["do","think?","you","What"]}'::jsonb, 4, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('433e8968-14ea-53b6-a1b0-98ba13e9eb38', 'd66a04d6-b209-5663-ba5d-6ac7efb26d54', 'listening', 'Послушайте', '{"en":"Listen","ru":"Послушайте"}'::jsonb, '{"audio_text":"I think this is a good plan.","instruction":"Напишите услышанное.","language":"en"}'::jsonb, 5, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('ffe25867-b8e7-53b7-aca6-c396c5033376', 'd66a04d6-b209-5663-ba5d-6ac7efb26d54', 'listening_shadowing', 'Повторите', '{"en":"Repeat","ru":"Повторите"}'::jsonb, '{"audio_text":"That is a good idea. Yes, I agree.","instruction":"Запишите повтор.","language":"en","min_accuracy":0.7,"translation_hint":"Это хорошая идея. Да, я согласен."}'::jsonb, 6, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('040b2718-f5a6-5b26-b30b-7c3d9bc0d596', 'd66a04d6-b209-5663-ba5d-6ac7efb26d54', 'story', 'История', '{"en":"Story","ru":"История"}'::jsonb, '{"instruction":"Прочитайте историю.","scenes":[{"character":"Eva","text":"I think we need a new plan.","translation":"Я думаю, нам нужен новый план.","type":"dialogue"},{"character":"Tom","text":"Yes, I agree.","translation":"Да, я согласен.","type":"dialogue"},{"options":[{"is_correct":true,"text":"What do you think, Anna?"},{"is_correct":false,"text":"Is the plan a manager?"}],"text":"What should Eva ask?","type":"choice"}],"title":"A New Plan"}'::jsonb, 7, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('3e18b86f-5679-5b95-8cc1-d4e809e8277f', 'd66a04d6-b209-5663-ba5d-6ac7efb26d54', 'choose_definition', 'Определение', '{"en":"Definition","ru":"Определение"}'::jsonb, '{"explanation":"“Agree” means to have the same opinion.","instruction":"Выберите значение.","language":"en","options":[{"id":"BESM_L2_D_A","is_correct":true,"text":"To have the same opinion"},{"id":"BESM_L2_D_B","is_correct":false,"text":"To begin a meeting"},{"id":"BESM_L2_D_C","is_correct":false,"text":"To write an email"}],"word":"agree"}'::jsonb, 8, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('76fc001b-b5fe-54ce-9592-909ef9d0d772', 'd66a04d6-b209-5663-ba5d-6ac7efb26d54', 'listen_choose_word', 'Слово', '{"en":"Word","ru":"Слово"}'::jsonb, '{"audio_text":"That is a good idea.","explanation":"The missing word is “idea.”","instruction":"Слушайте.","language":"en","options":[{"audio_text":"idea","id":"BESM_L2_LW_A","is_correct":true},{"audio_text":"client","id":"BESM_L2_LW_B","is_correct":false},{"audio_text":"morning","id":"BESM_L2_LW_C","is_correct":false}],"sentence_template":"That is a good ___."}'::jsonb, 9, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('b1a9a9c2-9d24-529b-9cc6-a1b7f593526b', 'd66a04d6-b209-5663-ba5d-6ac7efb26d54', 'missing_word', 'Впишите', '{"en":"Type","ru":"Впишите"}'::jsonb, '{"correct_answer":"agree","explanation":"The complete phrase is “I agree.”","hint_prefix":"ag","instruction":"Впишите пропущенное слово по подсказке.","sentence_template":"I ___."}'::jsonb, 10, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('11f4dfd3-7513-53c9-91ec-b6a84f9964c1', 'd66a04d6-b209-5663-ba5d-6ac7efb26d54', 'match_pairs_voice', 'Звук', '{"en":"Sound","ru":"Звук"}'::jsonb, '{"explanation":"Match each meeting phrase you hear with the same written English phrase.","instruction":"Соедините звук.","language":"en","pairs":[{"audio_text":"idea","id":"BESM_L2_VM_P1","text":"idea"},{"audio_text":"I agree","id":"BESM_L2_VM_P2","text":"I agree"},{"audio_text":"What do you think?","id":"BESM_L2_VM_P3","text":"What do you think?"}]}'::jsonb, 11, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('46e2c06b-7839-5f25-89b8-235d397b2253', 'd66a04d6-b209-5663-ba5d-6ac7efb26d54', 'complete_chat', 'Диалог', '{"en":"Chat","ru":"Диалог"}'::jsonb, '{"answer_speaker":"You","dialogue":[{"speaker":"Nina","text":"I think this is a good plan."}],"explanation":"“Yes, I agree” is a natural response to the opinion.","instruction":"Ответьте.","options":[{"id":"BESM_L2_C_A","is_correct":true,"text":"Yes, I agree."},{"id":"BESM_L2_C_B","is_correct":false,"text":"I am from a plan."},{"id":"BESM_L2_C_C","is_correct":false,"text":"My idea is five years old."}]}'::jsonb, 12, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();
...
INSERT INTO courses.lessons (id, module_id, title, description, title_i18n, description_i18n, order_index, created_at, updated_at)
VALUES ('a9cb17e5-95a7-5fe3-8a4d-6424d6c37dfb', NULL, 'Завершение встречи', 'Научиться подводить простой итог и завершать деловую встречу.', '{"en":"Ending a Meeting","ru":"Завершение встречи"}'::jsonb, '{"en":"Learn to give a simple summary and end a business meeting.","ru":"Научиться подводить простой итог и завершать деловую встречу."}'::jsonb, 2, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET title = EXCLUDED.title, description = EXCLUDED.description, title_i18n = EXCLUDED.title_i18n, description_i18n = EXCLUDED.description_i18n, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('19d09529-ed24-5eeb-b7e1-524f08399d9b', 'a9cb17e5-95a7-5fe3-8a4d-6424d6c37dfb', 'match_pairs', 'Соедините пары', '{"en":"Match the pairs","ru":"Соедините пары"}'::jsonb, '{"instruction":"Соедините английские слова с переводом.","pairs":[{"id":"BESM_L3_MP_P1","left":"finish","right":"заканчивать"},{"id":"BESM_L3_MP_P2","left":"next step","right":"следующий шаг"},{"id":"BESM_L3_MP_P3","left":"task","right":"задача"},{"id":"BESM_L3_MP_P4","left":"today","right":"сегодня"},{"id":"BESM_L3_MP_P5","left":"tomorrow","right":"завтра"},{"id":"BESM_L3_MP_P6","left":"Thank you, everyone","right":"Спасибо всем"},{"id":"BESM_L3_MP_P7","left":"See you tomorrow","right":"Увидимся завтра"}]}'::jsonb, 0, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('4f008734-73ed-5d10-bf7d-ab0dd35ba66e', 'a9cb17e5-95a7-5fe3-8a4d-6424d6c37dfb', 'quiz', 'Проверьте себя', '{"en":"Check yourself","ru":"Проверьте себя"}'::jsonb, '{"explanation":"“Thank you, everyone” politely thanks all participants at the end.","instruction":"Выберите правильный ответ.","options":[{"id":"BESM_L3_Q_A","is_correct":true,"text":"Thank you, everyone."},{"id":"BESM_L3_Q_B","is_correct":false,"text":"Please start yesterday."},{"id":"BESM_L3_Q_C","is_correct":false,"text":"I am tomorrow."}],"question":"What phrase politely closes a meeting?"}'::jsonb, 1, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('a9b0d7eb-537c-5b7e-abbe-f16ed2fb07c4', 'a9cb17e5-95a7-5fe3-8a4d-6424d6c37dfb', 'translate', 'Переведите', '{"en":"Translate","ru":"Переведите"}'::jsonb, '{"correct_translation":"The meeting is finished.","instruction":"Соберите перевод.","source_language":"ru","source_text":"Встреча закончена.","target_language":"en","word_bank":["finished.","is","meeting","The"]}'::jsonb, 2, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('9d3e97b4-3dae-588f-9ae4-b594c42719f8', 'a9cb17e5-95a7-5fe3-8a4d-6424d6c37dfb', 'fill_blank', 'Заполните пропуск', '{"en":"Fill the blank","ru":"Заполните пропуск"}'::jsonb, '{"correct_answer":"tomorrow","instruction":"Выберите подходящее слово.","options":["tomorrow","task","plan"],"sentence_template":"See you ___."}'::jsonb, 3, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('ef4c56e6-93b6-52dc-ba6c-329a8762cac1', 'a9cb17e5-95a7-5fe3-8a4d-6424d6c37dfb', 'tap_words', 'Соберите фразу', '{"en":"Build the phrase","ru":"Соберите фразу"}'::jsonb, '{"correct_words":["Thank","you,","everyone."],"instruction":"Расставьте слова в правильном порядке.","word_bank":["everyone.","you,","Thank"]}'::jsonb, 4, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('24a59c47-1160-5b2a-8ad0-507630e2380a', 'a9cb17e5-95a7-5fe3-8a4d-6424d6c37dfb', 'listening', 'Послушайте', '{"en":"Listen","ru":"Послушайте"}'::jsonb, '{"audio_text":"Thank you, everyone. The meeting is finished.","instruction":"Напишите услышанное.","language":"en"}'::jsonb, 5, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('9b65b638-4371-5e89-9cca-a8f65e4d24b5', 'a9cb17e5-95a7-5fe3-8a4d-6424d6c37dfb', 'listening_shadowing', 'Повторите', '{"en":"Repeat","ru":"Повторите"}'::jsonb, '{"audio_text":"Our next step is clear. See you tomorrow.","instruction":"Запишите повтор.","language":"en","min_accuracy":0.7,"translation_hint":"Наш следующий шаг понятен. Увидимся завтра."}'::jsonb, 6, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('4d7ded30-120a-5e68-bd23-2e8cd4aae6f5', 'a9cb17e5-95a7-5fe3-8a4d-6424d6c37dfb', 'story', 'История', '{"en":"Story","ru":"История"}'::jsonb, '{"instruction":"Прочитайте историю.","scenes":[{"character":"Manager","text":"Our next task is ready.","translation":"Наша следующая задача готова.","type":"dialogue"},{"character":"Team","text":"Great.","translation":"Отлично.","type":"dialogue"},{"options":[{"is_correct":true,"text":"Thank you, everyone. See you tomorrow."},{"is_correct":false,"text":"The task is a business card."}],"text":"What should the manager say?","type":"choice"}],"title":"The Meeting Ends"}'::jsonb, 7, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('8137dd34-ad38-5244-9cb1-209919d3b8e7', 'a9cb17e5-95a7-5fe3-8a4d-6424d6c37dfb', 'choose_definition', 'Определение', '{"en":"Definition","ru":"Определение"}'::jsonb, '{"explanation":"A task is a piece of work that needs to be done.","instruction":"Выберите значение.","language":"en","options":[{"id":"BESM_L3_D_A","is_correct":true,"text":"A piece of work that needs to be done"},{"id":"BESM_L3_D_B","is_correct":false,"text":"A person who attends a meeting"},{"id":"BESM_L3_D_C","is_correct":false,"text":"A place where a company works"}],"word":"task"}'::jsonb, 8, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('355600fc-a3eb-5555-b1c3-ed3e3a71a1d9', 'a9cb17e5-95a7-5fe3-8a4d-6424d6c37dfb', 'listen_choose_word', 'Слово', '{"en":"Word","ru":"Слово"}'::jsonb, '{"audio_text":"See you tomorrow.","explanation":"The missing word is “tomorrow.”","instruction":"Слушайте.","language":"en","options":[{"audio_text":"tomorrow","id":"BESM_L3_LW_A","is_correct":true},{"audio_text":"client","id":"BESM_L3_LW_B","is_correct":false},{"audio_text":"begin","id":"BESM_L3_LW_C","is_correct":false}],"sentence_template":"See you ___."}'::jsonb, 9, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('9c0285cf-a6ab-5fa4-8b79-790e89dafdaa', 'a9cb17e5-95a7-5fe3-8a4d-6424d6c37dfb', 'missing_word', 'Впишите', '{"en":"Type","ru":"Впишите"}'::jsonb, '{"correct_answer":"finished","explanation":"The complete sentence is “The meeting is finished.”","hint_prefix":"fi","instruction":"Впишите пропущенное слово по подсказке.","sentence_template":"The meeting is ___."}'::jsonb, 10, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('23a5868d-6132-5aa8-97e8-5779ded19ef5', 'a9cb17e5-95a7-5fe3-8a4d-6424d6c37dfb', 'match_pairs_voice', 'Звук', '{"en":"Sound","ru":"Звук"}'::jsonb, '{"explanation":"Match each meeting phrase you hear with the same written English phrase.","instruction":"Соедините звук.","language":"en","pairs":[{"audio_text":"next step","id":"BESM_L3_VM_P1","text":"next step"},{"audio_text":"Thank you, everyone","id":"BESM_L3_VM_P2","text":"Thank you, everyone"},{"audio_text":"See you tomorrow","id":"BESM_L3_VM_P3","text":"See you tomorrow"}]}'::jsonb, 11, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('8af43594-dca6-5fce-970c-8ee038b4cbc9', 'a9cb17e5-95a7-5fe3-8a4d-6424d6c37dfb', 'complete_chat', 'Диалог', '{"en":"Chat","ru":"Диалог"}'::jsonb, '{"answer_speaker":"You","dialogue":[{"speaker":"Manager","text":"That is all for today. Thank you, everyone."}],"explanation":"This is a polite and natural reply at the end of a meeting.","instruction":"Ответьте.","options":[{"id":"BESM_L3_C_A","is_correct":true,"text":"Thank you. See you tomorrow."},{"id":"BESM_L3_C_B","is_correct":false,"text":"I am all for today years old."},{"id":"BESM_L3_C_C","is_correct":false,"text":"My meeting is a client."}]}'::jsonb, 12, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();
