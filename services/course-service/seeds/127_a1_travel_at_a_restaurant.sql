...
VALUES ('8db3ef7f-7c2b-5818-aee6-2372df54d597', 'A1_TRAVEL_AT_A_RESTAURANT', 'В ресторане', 'Научитесь просить столик, заказывать еду и оплачивать счёт.', '{"en":"At a Restaurant","ru":"В ресторане"}'::jsonb, '{"en":"Learn to ask for a table, order food, and pay the bill.","ru":"Научитесь просить столик, заказывать еду и оплачивать счёт."}'::jsonb, 'en', 'A1', '', ARRAY['travel']::text[], true, 127, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET title = EXCLUDED.title, description = EXCLUDED.description, title_i18n = EXCLUDED.title_i18n, description_i18n = EXCLUDED.description_i18n, motivation = EXCLUDED.motivation, is_published = EXCLUDED.is_published, sort_order = EXCLUDED.sort_order, updated_at = NOW();

INSERT INTO courses.lessons (id, module_id, title, description, title_i18n, description_i18n, order_index, created_at, updated_at)
VALUES ('21144084-a4da-5c9a-8bf9-e8394ba9f19a', NULL, 'Столик и меню', 'Научиться попросить столик и меню в ресторане.', '{"en":"A Table and the Menu","ru":"Столик и меню"}'::jsonb, '{"en":"Learn to ask for a table and a menu in a restaurant.","ru":"Научиться попросить столик и меню в ресторане."}'::jsonb, 0, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET title = EXCLUDED.title, description = EXCLUDED.description, title_i18n = EXCLUDED.title_i18n, description_i18n = EXCLUDED.description_i18n, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('b5b313bd-2d99-51ea-aa3a-73c1a2868efc', '21144084-a4da-5c9a-8bf9-e8394ba9f19a', 'match_pairs', 'Соедините пары', '{"en":"Match the pairs","ru":"Соедините пары"}'::jsonb, '{"instruction":"Соедините английские слова с переводом.","pairs":[{"id":"TAR_L1_MP_P1","left":"restaurant","right":"ресторан"},{"id":"TAR_L1_MP_P2","left":"table","right":"столик"},{"id":"TAR_L1_MP_P3","left":"menu","right":"меню"},{"id":"TAR_L1_MP_P4","left":"waiter","right":"официант"},{"id":"TAR_L1_MP_P5","left":"waitress","right":"официантка"},{"id":"TAR_L1_MP_P6","left":"A table for two","right":"Столик на двоих"},{"id":"TAR_L1_MP_P7","left":"Here is the menu","right":"Вот меню"}]}'::jsonb, 0, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('c2e1b9bf-110f-5a4e-a839-a521745310e7', '21144084-a4da-5c9a-8bf9-e8394ba9f19a', 'quiz', 'Проверьте себя', '{"en":"Check yourself","ru":"Проверьте себя"}'::jsonb, '{"explanation":"A menu lists food and drinks.","instruction":"Выберите правильный ответ.","options":[{"id":"TAR_L1_Q_A","is_correct":true,"text":"The menu"},{"id":"TAR_L1_Q_B","is_correct":false,"text":"The boarding pass"},{"id":"TAR_L1_Q_C","is_correct":false,"text":"The room key"}],"question":"What do you read to choose food?"}'::jsonb, 1, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('0f4c5c25-7ab3-538e-87f2-e1b96e521af6', '21144084-a4da-5c9a-8bf9-e8394ba9f19a', 'translate', 'Переведите', '{"en":"Translate","ru":"Переведите"}'::jsonb, '{"correct_translation":"A table for two, please.","instruction":"Соберите перевод.","source_language":"ru","source_text":"Столик на двоих, пожалуйста.","target_language":"en","word_bank":["please.","two,","for","table","A"]}'::jsonb, 2, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('9c30c7b5-a29e-5c3d-9b23-ab6d587cd045', '21144084-a4da-5c9a-8bf9-e8394ba9f19a', 'fill_blank', 'Заполните пропуск', '{"en":"Fill the blank","ru":"Заполните пропуск"}'::jsonb, '{"correct_answer":"menu","instruction":"Выберите подходящее слово.","options":["menu","passport","room"],"sentence_template":"Can I see the ___?"}'::jsonb, 3, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('6d1047d7-cd18-5879-8ebb-7bb01a6adf43', '21144084-a4da-5c9a-8bf9-e8394ba9f19a', 'tap_words', 'Соберите фразу', '{"en":"Build the phrase","ru":"Соберите фразу"}'::jsonb, '{"correct_words":["Here","is","the","menu."],"instruction":"Расставьте слова в правильном порядке.","word_bank":["the","is","Here","menu."]}'::jsonb, 4, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('1af09040-d681-5297-b57c-aa2630e7276f', '21144084-a4da-5c9a-8bf9-e8394ba9f19a', 'listening', 'Послушайте', '{"en":"Listen","ru":"Послушайте"}'::jsonb, '{"audio_text":"A table for two, please.","instruction":"Напишите услышанное.","language":"en"}'::jsonb, 5, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('dc9849d7-fa93-523f-a588-bb7819db43e9', '21144084-a4da-5c9a-8bf9-e8394ba9f19a', 'listening_shadowing', 'Повторите', '{"en":"Repeat","ru":"Повторите"}'::jsonb, '{"audio_text":"Good evening. Can we see the menu, please?","instruction":"Запишите повтор.","language":"en","min_accuracy":0.7,"translation_hint":"Добрый вечер. Можно посмотреть меню, пожалуйста?"}'::jsonb, 6, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();
...
INSERT INTO courses.lessons (id, module_id, title, description, title_i18n, description_i18n, order_index, created_at, updated_at)
VALUES ('53019f62-9385-584f-9f2c-0710a2528a90', NULL, 'Заказываем еду', 'Научиться заказывать простую еду и напитки.', '{"en":"Ordering Food","ru":"Заказываем еду"}'::jsonb, '{"en":"Learn to order simple food and drinks.","ru":"Научиться заказывать простую еду и напитки."}'::jsonb, 1, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET title = EXCLUDED.title, description = EXCLUDED.description, title_i18n = EXCLUDED.title_i18n, description_i18n = EXCLUDED.description_i18n, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('0a15aa84-2abc-58c6-a34f-c254ecf1fae0', '53019f62-9385-584f-9f2c-0710a2528a90', 'match_pairs', 'Соедините пары', '{"en":"Match the pairs","ru":"Соедините пары"}'::jsonb, '{"instruction":"Соедините английские слова с переводом.","pairs":[{"id":"TAR_L2_MP_P1","left":"water","right":"вода"},{"id":"TAR_L2_MP_P2","left":"tea","right":"чай"},{"id":"TAR_L2_MP_P3","left":"coffee","right":"кофе"},{"id":"TAR_L2_MP_P4","left":"soup","right":"суп"},{"id":"TAR_L2_MP_P5","left":"salad","right":"салат"},{"id":"TAR_L2_MP_P6","left":"chicken","right":"курица"},{"id":"TAR_L2_MP_P7","left":"I would like","right":"Я бы хотел"}]}'::jsonb, 0, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('bdd6c43a-d2b5-510c-9490-9525fde71df6', '53019f62-9385-584f-9f2c-0710a2528a90', 'quiz', 'Проверьте себя', '{"en":"Check yourself","ru":"Проверьте себя"}'::jsonb, '{"explanation":"“I would like...” is a polite way to order.","instruction":"Выберите правильный ответ.","options":[{"id":"TAR_L2_Q_A","is_correct":true,"text":"I would like the soup."},{"id":"TAR_L2_Q_B","is_correct":false,"text":"My soup is a gate."},{"id":"TAR_L2_Q_C","is_correct":false,"text":"Where is the hotel soup?"}],"question":"Which phrase politely orders food?"}'::jsonb, 1, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('f39f4975-a1d2-55b6-a805-3d5b10ebde44', '53019f62-9385-584f-9f2c-0710a2528a90', 'translate', 'Переведите', '{"en":"Translate","ru":"Переведите"}'::jsonb, '{"correct_translation":"I would like the salad.","instruction":"Соберите перевод.","source_language":"ru","source_text":"Я бы хотел салат.","target_language":"en","word_bank":["salad.","the","like","would","I"]}'::jsonb, 2, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('7134578c-2aa7-5e8f-84e1-3c5fd2e4f790', '53019f62-9385-584f-9f2c-0710a2528a90', 'fill_blank', 'Заполните пропуск', '{"en":"Fill the blank","ru":"Заполните пропуск"}'::jsonb, '{"correct_answer":"water","instruction":"Выберите подходящее слово.","options":["water","passport","key"],"sentence_template":"I would like some ___."}'::jsonb, 3, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('43945c0b-d3cf-565e-bfbf-e21aee4cb690', '53019f62-9385-584f-9f2c-0710a2528a90', 'tap_words', 'Соберите фразу', '{"en":"Build the phrase","ru":"Соберите фразу"}'::jsonb, '{"correct_words":["A","coffee,","please."],"instruction":"Расставьте слова в правильном порядке.","word_bank":["coffee,","please.","A"]}'::jsonb, 4, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('aa66b83c-851f-5407-9a3f-d134001aba86', '53019f62-9385-584f-9f2c-0710a2528a90', 'listening', 'Послушайте', '{"en":"Listen","ru":"Послушайте"}'::jsonb, '{"audio_text":"I would like the chicken, please.","instruction":"Напишите услышанное.","language":"en"}'::jsonb, 5, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('200474e1-a91d-5b42-a6bc-705f364ec9c9', '53019f62-9385-584f-9f2c-0710a2528a90', 'listening_shadowing', 'Повторите', '{"en":"Repeat","ru":"Повторите"}'::jsonb, '{"audio_text":"Can I have the soup and a glass of water, please?","instruction":"Запишите повтор.","language":"en","min_accuracy":0.7,"translation_hint":"Можно мне суп и стакан воды, пожалуйста?"}'::jsonb, 6, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('59ff1351-f52d-51f2-abe1-3166d4ac2566', '53019f62-9385-584f-9f2c-0710a2528a90', 'story', 'История', '{"en":"Story","ru":"История"}'::jsonb, '{"instruction":"Прочитайте историю.","scenes":[{"character":"Waiter","text":"Are you ready to order?","translation":"Вы готовы сделать заказ?","type":"dialogue"},{"character":"Guest","text":"Yes. I would like the salad.","translation":"Да. Я бы хотел салат.","type":"dialogue"},{"options":[{"is_correct":true,"text":"Would you like a drink?"},{"is_correct":false,"text":"Where is your flight?"}],"text":"What can the waiter ask next?","type":"choice"}],"title":"Placing an Order"}'::jsonb, 7, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('af35bb4b-a9f5-5a26-9c94-dffb10221f67', '53019f62-9385-584f-9f2c-0710a2528a90', 'choose_definition', 'Определение', '{"en":"Definition","ru":"Определение"}'::jsonb, '{"explanation":"To order means to ask for food or drinks.","instruction":"Выберите значение.","language":"en","options":[{"id":"TAR_L2_D_A","is_correct":true,"text":"To ask for food or drinks in a restaurant"},{"id":"TAR_L2_D_B","is_correct":false,"text":"To book a hotel room"},{"id":"TAR_L2_D_C","is_correct":false,"text":"To enter an airplane"}],"word":"order"}'::jsonb, 8, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('f57f3db3-28a7-5beb-b26c-a4a5ac812afa', '53019f62-9385-584f-9f2c-0710a2528a90', 'listen_choose_word', 'Слово', '{"en":"Word","ru":"Слово"}'::jsonb, '{"audio_text":"I would like the soup.","explanation":"The missing food is “soup.”","instruction":"Слушайте.","language":"en","options":[{"audio_text":"soup","id":"TAR_L2_LW_A","is_correct":true},{"audio_text":"gate","id":"TAR_L2_LW_B","is_correct":false},{"audio_text":"towel","id":"TAR_L2_LW_C","is_correct":false}],"sentence_template":"I would like the ___."}'::jsonb, 9, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('93361bb1-2224-57ed-bf6d-73a7bcff28ec', '53019f62-9385-584f-9f2c-0710a2528a90', 'missing_word', 'Впишите', '{"en":"Type","ru":"Впишите"}'::jsonb, '{"correct_answer":"please","explanation":"The complete request is “A coffee, please.”","hint_prefix":"pl","instruction":"Впишите пропущенное слово по подсказке.","sentence_template":"A coffee, ___."}'::jsonb, 10, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('0fa1d066-24ef-5c2c-ae50-91dba3d2f476', '53019f62-9385-584f-9f2c-0710a2528a90', 'match_pairs_voice', 'Звук', '{"en":"Sound","ru":"Звук"}'::jsonb, '{"explanation":"Match each travel phrase you hear with the same written English phrase.","instruction":"Соедините звук.","language":"en","pairs":[{"audio_text":"water","id":"TAR_L2_VM_P1","text":"water"},{"audio_text":"soup","id":"TAR_L2_VM_P2","text":"soup"},{"audio_text":"chicken","id":"TAR_L2_VM_P3","text":"chicken"}]}'::jsonb, 11, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('03469f43-4b96-5a23-a17e-e8566d69f9aa', '53019f62-9385-584f-9f2c-0710a2528a90', 'complete_chat', 'Диалог', '{"en":"Chat","ru":"Диалог"}'::jsonb, '{"answer_speaker":"You","dialogue":[{"speaker":"Waiter","text":"What would you like?"}],"explanation":"This is a polite food order.","instruction":"Ответьте.","options":[{"id":"TAR_L2_C_A","is_correct":true,"text":"I would like the chicken, please."},{"id":"TAR_L2_C_B","is_correct":false,"text":"I have a hotel reservation."},{"id":"TAR_L2_C_C","is_correct":false,"text":"My gate is five."}]}'::jsonb, 12, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();
...
INSERT INTO courses.lessons (id, module_id, title, description, title_i18n, description_i18n, order_index, created_at, updated_at)
VALUES ('8470e67b-dca6-576c-a616-5e7aa6f3b2c4', NULL, 'Счёт и оплата', 'Научиться попросить счёт и оплатить еду.', '{"en":"The Bill and Payment","ru":"Счёт и оплата"}'::jsonb, '{"en":"Learn to ask for the bill and pay for a meal.","ru":"Научиться попросить счёт и оплатить еду."}'::jsonb, 2, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET title = EXCLUDED.title, description = EXCLUDED.description, title_i18n = EXCLUDED.title_i18n, description_i18n = EXCLUDED.description_i18n, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('6a8df641-f4c6-56a8-b857-067e8adec14d', '8470e67b-dca6-576c-a616-5e7aa6f3b2c4', 'match_pairs', 'Соедините пары', '{"en":"Match the pairs","ru":"Соедините пары"}'::jsonb, '{"instruction":"Соедините английские слова с переводом.","pairs":[{"id":"TAR_L3_MP_P1","left":"bill","right":"счёт"},{"id":"TAR_L3_MP_P2","left":"pay","right":"платить"},{"id":"TAR_L3_MP_P3","left":"cash","right":"наличные"},{"id":"TAR_L3_MP_P4","left":"card","right":"карта"},{"id":"TAR_L3_MP_P5","left":"tip","right":"чаевые"},{"id":"TAR_L3_MP_P6","left":"The food is good","right":"Еда хорошая"},{"id":"TAR_L3_MP_P7","left":"Can I have the bill?","right":"Можно мне счёт?"}]}'::jsonb, 0, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('a8bd6a4e-9805-5af1-ad24-914610a42c8c', '8470e67b-dca6-576c-a616-5e7aa6f3b2c4', 'quiz', 'Проверьте себя', '{"en":"Check yourself","ru":"Проверьте себя"}'::jsonb, '{"explanation":"Ask for the bill when you are ready to pay.","instruction":"Выберите правильный ответ.","options":[{"id":"TAR_L3_Q_A","is_correct":true,"text":"The bill"},{"id":"TAR_L3_Q_B","is_correct":false,"text":"The room key"},{"id":"TAR_L3_Q_C","is_correct":false,"text":"The boarding gate"}],"question":"What do you ask for when you finish eating and want to pay?"}'::jsonb, 1, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('b72fa65a-7644-5d62-9007-fb42f821c31f', '8470e67b-dca6-576c-a616-5e7aa6f3b2c4', 'translate', 'Переведите', '{"en":"Translate","ru":"Переведите"}'::jsonb, '{"correct_translation":"Can I have the bill, please?","instruction":"Соберите перевод.","source_language":"ru","source_text":"Можно мне счёт, пожалуйста?","target_language":"en","word_bank":["please?","bill,","the","have","I","Can"]}'::jsonb, 2, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('082acfbf-1d4f-50f1-a540-c4cb92840f49', '8470e67b-dca6-576c-a616-5e7aa6f3b2c4', 'fill_blank', 'Заполните пропуск', '{"en":"Fill the blank","ru":"Заполните пропуск"}'::jsonb, '{"correct_answer":"card","instruction":"Выберите подходящее слово.","options":["card","soup","hotel"],"sentence_template":"Can I pay by ___?"}'::jsonb, 3, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('8488c5ba-e5f6-5e33-8b06-566525eaf7f4', '8470e67b-dca6-576c-a616-5e7aa6f3b2c4', 'tap_words', 'Соберите фразу', '{"en":"Build the phrase","ru":"Соберите фразу"}'::jsonb, '{"correct_words":["The","food","is","good."],"instruction":"Расставьте слова в правильном порядке.","word_bank":["food","good.","is","The"]}'::jsonb, 4, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('f0ccb545-36ec-5ef3-99fa-f5953cf62176', '8470e67b-dca6-576c-a616-5e7aa6f3b2c4', 'listening', 'Послушайте', '{"en":"Listen","ru":"Послушайте"}'::jsonb, '{"audio_text":"Can I have the bill, please?","instruction":"Напишите услышанное.","language":"en"}'::jsonb, 5, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('cedf2f18-89cc-5d2d-8ad4-b6f3413368b0', '8470e67b-dca6-576c-a616-5e7aa6f3b2c4', 'listening_shadowing', 'Повторите', '{"en":"Repeat","ru":"Повторите"}'::jsonb, '{"audio_text":"The food was very good. Can I pay by card?","instruction":"Запишите повтор.","language":"en","min_accuracy":0.7,"translation_hint":"Еда была очень хорошей. Можно оплатить картой?"}'::jsonb, 6, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('8c36d49f-ee4e-5f07-8a25-94d4d9631cfe', '8470e67b-dca6-576c-a616-5e7aa6f3b2c4', 'story', 'История', '{"en":"Story","ru":"История"}'::jsonb, '{"instruction":"Прочитайте историю.","scenes":[{"character":"Guest","text":"Can I have the bill, please?","translation":"Можно мне счёт, пожалуйста?","type":"dialogue"},{"character":"Waiter","text":"Of course. Here you are.","translation":"Конечно. Вот, пожалуйста.","type":"dialogue"},{"options":[{"is_correct":true,"text":"Can I pay by card?"},{"is_correct":false,"text":"Where is gate two?"}],"text":"What should the guest ask?","type":"choice"}],"title":"After the Meal"}'::jsonb, 7, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('5362ce37-f727-578a-86ec-1d69a011c446', '8470e67b-dca6-576c-a616-5e7aa6f3b2c4', 'choose_definition', 'Определение', '{"en":"Definition","ru":"Определение"}'::jsonb, '{"explanation":"A tip is extra money given for service.","instruction":"Выберите значение.","language":"en","options":[{"id":"TAR_L3_D_A","is_correct":true,"text":"Extra money given for service"},{"id":"TAR_L3_D_B","is_correct":false,"text":"The total amount on the bill"},{"id":"TAR_L3_D_C","is_correct":false,"text":"A list of food and drinks"}],"word":"tip"}'::jsonb, 8, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('3e194f4c-0b1e-5b43-ae4e-ce1c49012c51', '8470e67b-dca6-576c-a616-5e7aa6f3b2c4', 'listen_choose_word', 'Слово', '{"en":"Word","ru":"Слово"}'::jsonb, '{"audio_text":"Can I pay by cash?","explanation":"The missing payment method is “cash.”","instruction":"Слушайте.","language":"en","options":[{"audio_text":"cash","id":"TAR_L3_LW_A","is_correct":true},{"audio_text":"menu","id":"TAR_L3_LW_B","is_correct":false},{"audio_text":"room","id":"TAR_L3_LW_C","is_correct":false}],"sentence_template":"Can I pay by ___?"}'::jsonb, 9, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('35d1c2b4-b0b8-5b59-9b90-ad887480d94f', '8470e67b-dca6-576c-a616-5e7aa6f3b2c4', 'missing_word', 'Впишите', '{"en":"Type","ru":"Впишите"}'::jsonb, '{"correct_answer":"bill","explanation":"The complete question is “Can I have the bill?”","hint_prefix":"bi","instruction":"Впишите пропущенное слово по подсказке.","sentence_template":"Can I have the ___?"}'::jsonb, 10, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();
