...
VALUES ('e472101c-5f77-5c2c-a5d4-97ac5a76cc8e', 'A1_WORK_MY_WORKDAY', 'Мой рабочий день', 'Научитесь говорить о времени работы, простых задачах, перерывах и расписании.', 'en', 'A1', '', ARRAY['work']::text[], true, 131, NOW(), NOW())
