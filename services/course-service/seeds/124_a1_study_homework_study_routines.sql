...
VALUES ('4a7f32f7-3d9e-5e0b-8867-0906315ed304', 'A1_STUDY_HOMEWORK_STUDY_ROUTINES', 'Домашняя работа и учебный распорядок', 'Научитесь говорить о домашних заданиях, времени занятий и выполнении учебных задач.', '{"en":"Homework and Study Routines","ru":"Домашняя работа и учебный распорядок"}'::jsonb, '{"en":"Learn to talk about homework, study times, and completing study tasks.","ru":"Научитесь говорить о домашних заданиях, времени занятий и выполнении учебных задач."}'::jsonb, 'en', 'A1', '', ARRAY['study']::text[], true, 124, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET title = EXCLUDED.title, description = EXCLUDED.description, title_i18n = EXCLUDED.title_i18n, description_i18n = EXCLUDED.description_i18n, motivation = EXCLUDED.motivation, is_published = EXCLUDED.is_published, sort_order = EXCLUDED.sort_order, updated_at = NOW();

INSERT INTO courses.lessons (id, module_id, title, description, title_i18n, description_i18n, order_index, created_at, updated_at)
VALUES ('1742ac73-a364-5060-a6b6-9d7e7c5621f8', NULL, 'Моя домашняя работа', 'Научиться называть простые домашние задания и говорить, что нужно сделать.', '{"en":"My Homework","ru":"Моя домашняя работа"}'::jsonb, '{"en":"Learn to name simple homework tasks and say what you need to do.","ru":"Научиться называть простые домашние задания и говорить, что нужно сделать."}'::jsonb, 0, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET title = EXCLUDED.title, description = EXCLUDED.description, title_i18n = EXCLUDED.title_i18n, description_i18n = EXCLUDED.description_i18n, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('0cc542ba-09d9-59fb-bc7c-4ff0a437854b', '1742ac73-a364-5060-a6b6-9d7e7c5621f8', 'match_pairs', 'Соедините пары', '{"en":"Match the pairs","ru":"Соедините пары"}'::jsonb, '{"instruction":"Соедините английские слова с переводом.","pairs":[{"id":"HSR_L1_MP_P1","left":"homework","right":"домашняя работа"},{"id":"HSR_L1_MP_P2","left":"exercise","right":"упражнение"},{"id":"HSR_L1_MP_P3","left":"question","right":"вопрос"},{"id":"HSR_L1_MP_P4","left":"answer","right":"ответ"},{"id":"HSR_L1_MP_P5","left":"read a book","right":"читать книгу"},{"id":"HSR_L1_MP_P6","left":"write a sentence","right":"написать предложение"},{"id":"HSR_L1_MP_P7","left":"learn new words","right":"учить новые слова"}]}'::jsonb, 0, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('95b96794-25bd-5682-a37f-7e9204a9f079', '1742ac73-a364-5060-a6b6-9d7e7c5621f8', 'quiz', 'Проверьте себя', '{"en":"Check yourself","ru":"Проверьте себя"}'::jsonb, '{"explanation":"To write a sentence means to put a group of words on paper.","instruction":"Выберите правильный ответ.","options":[{"id":"HSR_L1_Q_A","is_correct":true,"text":"Write a sentence"},{"id":"HSR_L1_Q_B","is_correct":false,"text":"Read a book"},{"id":"HSR_L1_Q_C","is_correct":false,"text":"Learn new words"}],"question":"Which activity means putting words on paper?"}'::jsonb, 1, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('d15b05db-6543-5c93-b61b-89ff1fa8fd5a', '1742ac73-a364-5060-a6b6-9d7e7c5621f8', 'translate', 'Переведите', '{"en":"Translate","ru":"Переведите"}'::jsonb, '{"correct_translation":"I have homework.","instruction":"Соберите перевод.","source_language":"ru","source_text":"У меня есть домашняя работа.","target_language":"en","word_bank":["homework.","have","I"]}'::jsonb, 2, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('d420df52-ae19-506b-8ead-1603d1dca9f5', '1742ac73-a364-5060-a6b6-9d7e7c5621f8', 'fill_blank', 'Заполните пропуск', '{"en":"Fill the blank","ru":"Заполните пропуск"}'::jsonb, '{"correct_answer":"read","instruction":"Выберите подходящее слово.","options":["read","desk","Monday"],"sentence_template":"I need to ___ a book."}'::jsonb, 3, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('d0e4ca6c-945f-5158-aa9b-634ee84e185b', '1742ac73-a364-5060-a6b6-9d7e7c5621f8', 'tap_words', 'Соберите фразу', '{"en":"Build the phrase","ru":"Соберите фразу"}'::jsonb, '{"correct_words":["I","learn","new","words."],"instruction":"Расставьте слова в правильном порядке.","word_bank":["new","learn","I","words."]}'::jsonb, 4, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('69fb91ce-02e4-57d0-bea2-ab4695053344', '1742ac73-a364-5060-a6b6-9d7e7c5621f8', 'listening', 'Послушайте', '{"en":"Listen","ru":"Послушайте"}'::jsonb, '{"audio_text":"I have English homework today.","instruction":"Напишите услышанное.","language":"en"}'::jsonb, 5, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('7fb9e7cd-33c2-578d-8366-37340d621d42', '1742ac73-a364-5060-a6b6-9d7e7c5621f8', 'listening_shadowing', 'Повторите', '{"en":"Repeat","ru":"Повторите"}'::jsonb, '{"audio_text":"I need to read a book and write two sentences.","instruction":"Запишите повтор.","language":"en","min_accuracy":0.7,"translation_hint":"Мне нужно прочитать книгу и написать два предложения."}'::jsonb, 6, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();
...
INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('8ce3bd11-b6fe-5d17-9497-df8b2e4b279e', '1742ac73-a364-5060-a6b6-9d7e7c5621f8', 'choose_definition', 'Определение', '{"en":"Definition","ru":"Определение"}'::jsonb, '{"explanation":"An exercise is a task that helps you practise something.","instruction":"Выберите значение.","language":"en","options":[{"id":"HSR_L1_D_A","is_correct":true,"text":"A task that helps you practise something"},{"id":"HSR_L1_D_B","is_correct":false,"text":"A person who teaches a class"},{"id":"HSR_L1_D_C","is_correct":false,"text":"A day after Monday"}],"word":"exercise"}'::jsonb, 8, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('42f03822-1e6c-5a91-be4b-addbc566200c', '1742ac73-a364-5060-a6b6-9d7e7c5621f8', 'listen_choose_word', 'Слово', '{"en":"Word","ru":"Слово"}'::jsonb, '{"audio_text":"I have homework today.","explanation":"The complete sentence is “I have homework today.”","instruction":"Слушайте.","language":"en","options":[{"audio_text":"homework","id":"HSR_L1_LW_A","is_correct":true},{"audio_text":"Friday","id":"HSR_L1_LW_B","is_correct":false},{"audio_text":"pencil","id":"HSR_L1_LW_C","is_correct":false}],"sentence_template":"I have ___ today."}'::jsonb, 9, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('02fcaaab-3db6-5b61-8a86-578992f7c6ca', '1742ac73-a364-5060-a6b6-9d7e7c5621f8', 'missing_word', 'Впишите', '{"en":"Type","ru":"Впишите"}'::jsonb, '{"correct_answer":"write","explanation":"The complete sentence is “I need to write a sentence.”","hint_prefix":"wr","instruction":"Впишите пропущенное слово по подсказке.","sentence_template":"I need to ___ a sentence."}'::jsonb, 10, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('2a6e3454-cfc9-545a-8c0a-0cfdd7a0a122', '1742ac73-a364-5060-a6b6-9d7e7c5621f8', 'match_pairs_voice', 'Звук', '{"en":"Sound","ru":"Звук"}'::jsonb, '{"explanation":"Match each audio item with the same written English word or phrase.","instruction":"Соедините звук.","language":"en","pairs":[{"audio_text":"homework","id":"HSR_L1_VM_P1","text":"homework"},{"audio_text":"exercise","id":"HSR_L1_VM_P2","text":"exercise"},{"audio_text":"answer","id":"HSR_L1_VM_P3","text":"answer"}]}'::jsonb, 11, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('99a23e02-a1fd-5e5b-bc68-ce80c5156375', '1742ac73-a364-5060-a6b6-9d7e7c5621f8', 'complete_chat', 'Диалог', '{"en":"Chat","ru":"Диалог"}'::jsonb, '{"answer_speaker":"You","dialogue":[{"speaker":"Mila","text":"What is your English homework?"}],"explanation":"This answer clearly describes the homework task.","instruction":"Ответьте.","options":[{"id":"HSR_L1_C_A","is_correct":true,"text":"I need to learn five new words."},{"id":"HSR_L1_C_B","is_correct":false,"text":"I am five homework."},{"id":"HSR_L1_C_C","is_correct":false,"text":"My words are Tuesday."}]}'::jsonb, 12, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();
...
INSERT INTO courses.lessons (id, module_id, title, description, title_i18n, description_i18n, order_index, created_at, updated_at)
VALUES ('a6a278df-3f9a-503f-887b-8e124a1b3dd0', NULL, 'Мой учебный распорядок', 'Научиться рассказывать, когда и где вы обычно занимаетесь.', '{"en":"My Study Routine","ru":"Мой учебный распорядок"}'::jsonb, '{"en":"Learn to say when and where you usually study.","ru":"Научиться рассказывать, когда и где вы обычно занимаетесь."}'::jsonb, 1, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET title = EXCLUDED.title, description = EXCLUDED.description, title_i18n = EXCLUDED.title_i18n, description_i18n = EXCLUDED.description_i18n, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('719fc3e0-4777-5bfa-9599-5a64a8aa4744', 'a6a278df-3f9a-503f-887b-8e124a1b3dd0', 'match_pairs', 'Соедините пары', '{"en":"Match the pairs","ru":"Соедините пары"}'::jsonb, '{"instruction":"Соедините английские слова с переводом.","pairs":[{"id":"HSR_L2_MP_P1","left":"study","right":"заниматься"},{"id":"HSR_L2_MP_P2","left":"after school","right":"после школы"},{"id":"HSR_L2_MP_P3","left":"in the evening","right":"вечером"},{"id":"HSR_L2_MP_P4","left":"every day","right":"каждый день"},{"id":"HSR_L2_MP_P5","left":"at home","right":"дома"},{"id":"HSR_L2_MP_P6","left":"at my desk","right":"за моей партой"},{"id":"HSR_L2_MP_P7","left":"take a break","right":"сделать перерыв"}]}'::jsonb, 0, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();
...
INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('8a8cf47a-ea5e-5328-a8fe-9de34afdb5d9', 'a6a278df-3f9a-503f-887b-8e124a1b3dd0', 'translate', 'Переведите', '{"en":"Translate","ru":"Переведите"}'::jsonb, '{"correct_translation":"I study at home every day.","instruction":"Соберите перевод.","source_language":"ru","source_text":"Я занимаюсь дома каждый день.","target_language":"en","word_bank":["day.","every","home","at","study","I"]}'::jsonb, 2, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('6e88838d-5024-5fa7-92c4-98a710ba78dd', 'a6a278df-3f9a-503f-887b-8e124a1b3dd0', 'fill_blank', 'Заполните пропуск', '{"en":"Fill the blank","ru":"Заполните пропуск"}'::jsonb, '{"correct_answer":"after","instruction":"Выберите подходящее слово.","options":["after","book","science"],"sentence_template":"I study ___ school."}'::jsonb, 3, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('421acfcf-da53-54db-9634-b339901aab40', 'a6a278df-3f9a-503f-887b-8e124a1b3dd0', 'tap_words', 'Соберите фразу', '{"en":"Build the phrase","ru":"Соберите фразу"}'::jsonb, '{"correct_words":["I","study","in","the","evening."],"instruction":"Расставьте слова в правильном порядке.","word_bank":["evening.","the","in","study","I"]}'::jsonb, 4, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('bca4e14a-365a-5f01-8ef1-05039771b744', 'a6a278df-3f9a-503f-887b-8e124a1b3dd0', 'listening', 'Послушайте', '{"en":"Listen","ru":"Послушайте"}'::jsonb, '{"audio_text":"I study at home after school.","instruction":"Напишите услышанное.","language":"en"}'::jsonb, 5, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('760797f5-153c-5494-bfb6-530fc2c208fc', 'a6a278df-3f9a-503f-887b-8e124a1b3dd0', 'listening_shadowing', 'Повторите', '{"en":"Repeat","ru":"Повторите"}'::jsonb, '{"audio_text":"I study at my desk every day, and then I take a break.","instruction":"Запишите повтор.","language":"en","min_accuracy":0.7,"translation_hint":"Я занимаюсь за своим столом каждый день, а затем делаю перерыв."}'::jsonb, 6, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();
...
INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('561b36f6-109c-5745-8f2e-1bbf363d6973', 'a6a278df-3f9a-503f-887b-8e124a1b3dd0', 'choose_definition', 'Определение', '{"en":"Definition","ru":"Определение"}'::jsonb, '{"explanation":"A break is a short time when you stop working or studying.","instruction":"Выберите значение.","language":"en","options":[{"id":"HSR_L2_D_A","is_correct":true,"text":"A short time when you stop working or studying"},{"id":"HSR_L2_D_B","is_correct":false,"text":"A task from a teacher"},{"id":"HSR_L2_D_C","is_correct":false,"text":"A room where students learn"}],"word":"break"}'::jsonb, 8, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('abb62842-a272-57b3-a705-459ed6a702a3', 'a6a278df-3f9a-503f-887b-8e124a1b3dd0', 'listen_choose_word', 'Слово', '{"en":"Word","ru":"Слово"}'::jsonb, '{"audio_text":"I study at home.","explanation":"The complete sentence is “I study at home.”","instruction":"Слушайте.","language":"en","options":[{"audio_text":"home","id":"HSR_L2_LW_A","is_correct":true},{"audio_text":"history","id":"HSR_L2_LW_B","is_correct":false},{"audio_text":"answer","id":"HSR_L2_LW_C","is_correct":false}],"sentence_template":"I study at ___."}'::jsonb, 9, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('a2cef69d-cff9-50ed-8c1f-5aa5bb356460', 'a6a278df-3f9a-503f-887b-8e124a1b3dd0', 'missing_word', 'Впишите', '{"en":"Type","ru":"Впишите"}'::jsonb, '{"correct_answer":"day","explanation":"The complete sentence is “I study every day.”","hint_prefix":"da","instruction":"Впишите пропущенное слово по подсказке.","sentence_template":"I study every ___."}'::jsonb, 10, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('c2e3f32b-eeee-5366-9c02-cbe7cf4c9b1f', 'a6a278df-3f9a-503f-887b-8e124a1b3dd0', 'match_pairs_voice', 'Звук', '{"en":"Sound","ru":"Звук"}'::jsonb, '{"explanation":"Match each audio item with the same written English word or phrase.","instruction":"Соедините звук.","language":"en","pairs":[{"audio_text":"study","id":"HSR_L2_VM_P1","text":"study"},{"audio_text":"after school","id":"HSR_L2_VM_P2","text":"after school"},{"audio_text":"take a break","id":"HSR_L2_VM_P3","text":"take a break"}]}'::jsonb, 11, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('c329332f-9cec-5fe4-b741-8f0e2370971b', 'a6a278df-3f9a-503f-887b-8e124a1b3dd0', 'complete_chat', 'Диалог', '{"en":"Chat","ru":"Диалог"}'::jsonb, '{"answer_speaker":"You","dialogue":[{"speaker":"Sam","text":"When do you study?"}],"explanation":"“I study in the evening” naturally answers a question about study time.","instruction":"Ответьте.","options":[{"id":"HSR_L2_C_A","is_correct":true,"text":"I study in the evening."},{"id":"HSR_L2_C_B","is_correct":false,"text":"I am evening years old."},{"id":"HSR_L2_C_C","is_correct":false,"text":"My study is a pencil."}]}'::jsonb, 12, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();
...
INSERT INTO courses.lessons (id, module_id, title, description, title_i18n, description_i18n, order_index, created_at, updated_at)
VALUES ('63ade9a6-d94c-5c74-844b-eb8d47254b42', NULL, 'Заканчиваем задания', 'Научиться говорить о начале, выполнении и проверке учебных заданий.', '{"en":"Completing Study Tasks","ru":"Заканчиваем задания"}'::jsonb, '{"en":"Learn to talk about starting, completing, and checking study tasks.","ru":"Научиться говорить о начале, выполнении и проверке учебных заданий."}'::jsonb, 2, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET title = EXCLUDED.title, description = EXCLUDED.description, title_i18n = EXCLUDED.title_i18n, description_i18n = EXCLUDED.description_i18n, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('e85e614f-730d-59b7-a179-fc758011a32a', '63ade9a6-d94c-5c74-844b-eb8d47254b42', 'match_pairs', 'Соедините пары', '{"en":"Match the pairs","ru":"Соедините пары"}'::jsonb, '{"instruction":"Соедините английские слова с переводом.","pairs":[{"id":"HSR_L3_MP_P1","left":"start","right":"начинать"},{"id":"HSR_L3_MP_P2","left":"finish","right":"заканчивать"},{"id":"HSR_L3_MP_P3","left":"check","right":"проверять"},{"id":"HSR_L3_MP_P4","left":"correct","right":"правильный"},{"id":"HSR_L3_MP_P5","left":"mistake","right":"ошибка"},{"id":"HSR_L3_MP_P6","left":"ready","right":"готов"},{"id":"HSR_L3_MP_P7","left":"Good job!","right":"Отличная работа!"}]}'::jsonb, 0, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('b3e963ac-5a44-533f-b3dc-3f6cb3bd2afa', '63ade9a6-d94c-5c74-844b-eb8d47254b42', 'quiz', 'Проверьте себя', '{"en":"Check yourself","ru":"Проверьте себя"}'::jsonb, '{"explanation":"Checking your work helps you find mistakes.","instruction":"Выберите правильный ответ.","options":[{"id":"HSR_L3_Q_A","is_correct":true,"text":"Check your work"},{"id":"HSR_L3_Q_B","is_correct":false,"text":"Start a break"},{"id":"HSR_L3_Q_C","is_correct":false,"text":"Close the answer"}],"question":"What should you do to look for mistakes?"}'::jsonb, 1, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('360b7380-5225-5d30-8c3c-7ea82ab5ed99', '63ade9a6-d94c-5c74-844b-eb8d47254b42', 'translate', 'Переведите', '{"en":"Translate","ru":"Переведите"}'::jsonb, '{"correct_translation":"I finished my homework.","instruction":"Соберите перевод.","source_language":"ru","source_text":"Я закончил домашнюю работу.","target_language":"en","word_bank":["homework.","my","finished","I"]}'::jsonb, 2, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('9b768cf6-08ee-5996-9b4d-eac7b4ef35e9', '63ade9a6-d94c-5c74-844b-eb8d47254b42', 'fill_blank', 'Заполните пропуск', '{"en":"Fill the blank","ru":"Заполните пропуск"}'::jsonb, '{"correct_answer":"check","instruction":"Выберите подходящее слово.","options":["check","chair","music"],"sentence_template":"Please ___ your answers."}'::jsonb, 3, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('b9e38878-07dc-5cc3-b36f-ed5d95b120a8', '63ade9a6-d94c-5c74-844b-eb8d47254b42', 'tap_words', 'Соберите фразу', '{"en":"Build the phrase","ru":"Соберите фразу"}'::jsonb, '{"correct_words":["I","am","ready."],"instruction":"Расставьте слова в правильном порядке.","word_bank":["am","I","ready."]}'::jsonb, 4, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('ce7b5678-44f0-5386-80e2-325c1ec491f3', '63ade9a6-d94c-5c74-844b-eb8d47254b42', 'listening', 'Послушайте', '{"en":"Listen","ru":"Послушайте"}'::jsonb, '{"audio_text":"I finished my homework.","instruction":"Напишите услышанное.","language":"en"}'::jsonb, 5, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('a2b1e9ec-b891-5034-938a-a57e936fddcb', '63ade9a6-d94c-5c74-844b-eb8d47254b42', 'listening_shadowing', 'Повторите', '{"en":"Repeat","ru":"Повторите"}'::jsonb, '{"audio_text":"I check my answers and correct my mistakes.","instruction":"Запишите повтор.","language":"en","min_accuracy":0.7,"translation_hint":"Я проверяю ответы и исправляю ошибки."}'::jsonb, 6, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();
...
INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('8e33b827-7fd1-596b-a6eb-ca39a03a742b', '63ade9a6-d94c-5c74-844b-eb8d47254b42', 'choose_definition', 'Определение', '{"en":"Definition","ru":"Определение"}'::jsonb, '{"explanation":"A mistake is something that is not correct.","instruction":"Выберите значение.","language":"en","options":[{"id":"HSR_L3_D_A","is_correct":true,"text":"Something that is not correct"},{"id":"HSR_L3_D_B","is_correct":false,"text":"Something that is fully prepared"},{"id":"HSR_L3_D_C","is_correct":false,"text":"The beginning of a task"}],"word":"mistake"}'::jsonb, 8, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('84fc2866-64e5-53fa-922c-95bb855ec6bf', '63ade9a6-d94c-5c74-844b-eb8d47254b42', 'listen_choose_word', 'Слово', '{"en":"Word","ru":"Слово"}'::jsonb, '{"audio_text":"Please check your work.","explanation":"The complete instruction is “Please check your work.”","instruction":"Слушайте.","language":"en","options":[{"audio_text":"check","id":"HSR_L3_LW_A","is_correct":true},{"audio_text":"subject","id":"HSR_L3_LW_B","is_correct":false},{"audio_text":"evening","id":"HSR_L3_LW_C","is_correct":false}],"sentence_template":"Please ___ your work."}'::jsonb, 9, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('18964d8d-0c90-51e7-90dd-5a2a336a5b7e', '63ade9a6-d94c-5c74-844b-eb8d47254b42', 'missing_word', 'Впишите', '{"en":"Type","ru":"Впишите"}'::jsonb, '{"correct_answer":"ready","explanation":"The complete sentence is “I am ready.”","hint_prefix":"re","instruction":"Впишите пропущенное слово по подсказке.","sentence_template":"I am ___."}'::jsonb, 10, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('87919c7e-88aa-55a3-83d8-768962050bd6', '63ade9a6-d94c-5c74-844b-eb8d47254b42', 'match_pairs_voice', 'Звук', '{"en":"Sound","ru":"Звук"}'::jsonb, '{"explanation":"Match each audio item with the same written English word or phrase.","instruction":"Соедините звук.","language":"en","pairs":[{"audio_text":"finish","id":"HSR_L3_VM_P1","text":"finish"},{"audio_text":"check","id":"HSR_L3_VM_P2","text":"check"},{"audio_text":"mistake","id":"HSR_L3_VM_P3","text":"mistake"}]}'::jsonb, 11, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('e3f2feed-97fe-5f38-b652-ec6c74efb263', '63ade9a6-d94c-5c74-844b-eb8d47254b42', 'complete_chat', 'Диалог', '{"en":"Chat","ru":"Диалог"}'::jsonb, '{"answer_speaker":"You","dialogue":[{"speaker":"Teacher","text":"Did you finish your homework?"}],"explanation":"This response clearly says the homework is finished and checked.","instruction":"Ответьте.","options":[{"id":"HSR_L3_C_A","is_correct":true,"text":"Yes, I finished it and checked my answers."},{"id":"HSR_L3_C_B","is_correct":false,"text":"Yes, my homework is a city."},{"id":"HSR_L3_C_C","is_correct":false,"text":"I am from an answer."}]}'::jsonb, 12, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();
