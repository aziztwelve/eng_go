...
VALUES ('c0d430aa-0955-595b-bacd-bc2bdc2535b8', 'A1_SPEAKING_ABOUT_MYSELF', 'О себе', 'Научитесь рассказывать своё имя, возраст, откуда вы и что вам нравится.', 'en', 'A1', '', ARRAY['speaking']::text[], true, 121, NOW(), NOW())
