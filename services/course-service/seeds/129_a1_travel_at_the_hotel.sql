...
VALUES ('d35a0e0b-a640-506e-b34e-c9152b27f733', 'A1_TRAVEL_AT_THE_HOTEL', 'В отеле', 'Научитесь регистрироваться в отеле, говорить о номере и выезжать.', 'en', 'A1', '', ARRAY['travel']::text[], true, 29, NOW(), NOW())
