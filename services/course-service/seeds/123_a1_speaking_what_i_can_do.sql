...
VALUES ('45c085d8-9d91-543f-99a0-61cac4315235', 'A1_SPEAKING_WHAT_I_CAN_DO', 'Что я умею делать', 'Научитесь говорить о своих способностях и спрашивать других, что они умеют делать.', '{"en":"What I Can Do","ru":"Что я умею делать"}'::jsonb, '{"en":"Learn to talk about your abilities and ask others what they can do.","ru":"Научитесь говорить о своих способностях и спрашивать других, что они умеют делать."}'::jsonb, 'en', 'A1', '', ARRAY['speaking']::text[], true, 123, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET title = EXCLUDED.title, description = EXCLUDED.description, title_i18n = EXCLUDED.title_i18n, description_i18n = EXCLUDED.description_i18n, motivation = EXCLUDED.motivation, is_published = EXCLUDED.is_published, sort_order = EXCLUDED.sort_order, updated_at = NOW();

INSERT INTO courses.lessons (id, module_id, title, description, title_i18n, description_i18n, order_index, created_at, updated_at)
VALUES ('37b28cca-c93e-56e4-b7ea-72be66881b47', NULL, 'Мои способности', 'Научиться называть простые действия, которые вы умеете выполнять.', '{"en":"My Abilities","ru":"Мои способности"}'::jsonb, '{"en":"Learn to name simple actions that you can do.","ru":"Научиться называть простые действия, которые вы умеете выполнять."}'::jsonb, 0, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET title = EXCLUDED.title, description = EXCLUDED.description, title_i18n = EXCLUDED.title_i18n, description_i18n = EXCLUDED.description_i18n, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('b51d12a9-5e1a-5c77-8f14-401d745c8414', '37b28cca-c93e-56e4-b7ea-72be66881b47', 'match_pairs', 'Соедините пары', '{"en":"Match the pairs","ru":"Соедините пары"}'::jsonb, '{"instruction":"Соедините английские слова с переводом.","pairs":[{"id":"WICD_L1_MP_P1","left":"run","right":"бегать"},{"id":"WICD_L1_MP_P2","left":"swim","right":"плавать"},{"id":"WICD_L1_MP_P3","left":"read","right":"читать"},{"id":"WICD_L1_MP_P4","left":"write","right":"писать"},{"id":"WICD_L1_MP_P5","left":"sing","right":"петь"},{"id":"WICD_L1_MP_P6","left":"dance","right":"танцевать"},{"id":"WICD_L1_MP_P7","left":"draw","right":"рисовать"}]}'::jsonb, 0, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('3877fc1a-5121-5062-aa25-71e8b200a90f', '37b28cca-c93e-56e4-b7ea-72be66881b47', 'quiz', 'Проверьте себя', '{"en":"Check yourself","ru":"Проверьте себя"}'::jsonb, '{"explanation":"“I can swim” says that you have the ability to swim.","instruction":"Выберите правильный ответ.","options":[{"id":"WICD_L1_Q_A","is_correct":true,"text":"I can swim."},{"id":"WICD_L1_Q_B","is_correct":false,"text":"I am swim."},{"id":"WICD_L1_Q_C","is_correct":false,"text":"I like can."}],"question":"Which sentence says you have an ability?"}'::jsonb, 1, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('9a50ed3f-cdf0-5a2c-863d-2f3a82196706', '37b28cca-c93e-56e4-b7ea-72be66881b47', 'translate', 'Переведите', '{"en":"Translate","ru":"Переведите"}'::jsonb, '{"correct_translation":"I can read.","instruction":"Соберите перевод.","source_language":"ru","source_text":"Я умею читать.","target_language":"en","word_bank":["read.","can","I"]}'::jsonb, 2, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('3a0e6170-f34a-53d9-bc24-9657fa6943b7', '37b28cca-c93e-56e4-b7ea-72be66881b47', 'fill_blank', 'Заполните пропуск', '{"en":"Fill the blank","ru":"Заполните пропуск"}'::jsonb, '{"correct_answer":"dance","instruction":"Выберите подходящее слово.","options":["dance","name","city"],"sentence_template":"I can ___."}'::jsonb, 3, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('f430cbd5-a280-5c72-ad65-1bc41cf977df', '37b28cca-c93e-56e4-b7ea-72be66881b47', 'tap_words', 'Соберите фразу', '{"en":"Build the phrase","ru":"Соберите фразу"}'::jsonb, '{"correct_words":["I","can","draw."],"instruction":"Расставьте слова в правильном порядке.","word_bank":["draw.","can","I"]}'::jsonb, 4, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('7d447e30-c19a-586e-a3a4-41f9f0065dc2', '37b28cca-c93e-56e4-b7ea-72be66881b47', 'listening', 'Послушайте', '{"en":"Listen","ru":"Послушайте"}'::jsonb, '{"audio_text":"I can read and write.","instruction":"Напишите услышанное.","language":"en"}'::jsonb, 5, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('58968090-d501-5924-a699-200931d7a6f6', '37b28cca-c93e-56e4-b7ea-72be66881b47', 'listening_shadowing', 'Повторите', '{"en":"Repeat","ru":"Повторите"}'::jsonb, '{"audio_text":"I can sing, dance, and draw.","instruction":"Запишите повтор.","language":"en","min_accuracy":0.7,"translation_hint":"Я умею петь, танцевать и рисовать."}'::jsonb, 6, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('acbb4f80-f9a2-5cc7-9731-0de11abf63b9', '37b28cca-c93e-56e4-b7ea-72be66881b47', 'story', 'История', '{"en":"Story","ru":"История"}'::jsonb, '{"instruction":"Прочитайте историю.","scenes":[{"character":"Eva","text":"I can draw a cat.","translation":"Я умею рисовать кошку.","type":"dialogue"},{"character":"Ben","text":"I can draw too.","translation":"Я тоже умею рисовать.","type":"dialogue"},{"options":[{"is_correct":true,"text":"Let us draw together."},{"is_correct":false,"text":"I am ten draw."}],"text":"What can Eva say next?","type":"choice"}],"title":"The Art Class"}'::jsonb, 7, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('01d675b3-22dd-5285-9e18-381d0dd44537', '37b28cca-c93e-56e4-b7ea-72be66881b47', 'choose_definition', 'Определение', '{"en":"Definition","ru":"Определение"}'::jsonb, '{"explanation":"“Swim” means to move through water.","instruction":"Выберите значение.","language":"en","options":[{"id":"WICD_L1_D_A","is_correct":true,"text":"To move through water"},{"id":"WICD_L1_D_B","is_correct":false,"text":"To make words on paper"},{"id":"WICD_L1_D_C","is_correct":false,"text":"To make music with your voice"}],"word":"swim"}'::jsonb, 8, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('2192569c-7721-5acd-8837-866788736587', '37b28cca-c93e-56e4-b7ea-72be66881b47', 'listen_choose_word', 'Слово', '{"en":"Word","ru":"Слово"}'::jsonb, '{"audio_text":"I can sing.","explanation":"The complete sentence is “I can sing.”","instruction":"Слушайте.","language":"en","options":[{"audio_text":"sing","id":"WICD_L1_LW_A","is_correct":true},{"audio_text":"age","id":"WICD_L1_LW_B","is_correct":false},{"audio_text":"from","id":"WICD_L1_LW_C","is_correct":false}],"sentence_template":"I can ___."}'::jsonb, 9, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('9a4784b1-9678-5b3a-aac1-7bb983dbe7ab', '37b28cca-c93e-56e4-b7ea-72be66881b47', 'missing_word', 'Впишите', '{"en":"Type","ru":"Впишите"}'::jsonb, '{"correct_answer":"read","explanation":"The complete sentence is “I can read.”","hint_prefix":"re","instruction":"Впишите пропущенное слово по подсказке.","sentence_template":"I can ___."}'::jsonb, 10, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();
...
INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('de5eda0e-93d7-5331-8887-3ff7c99798a2', '37b28cca-c93e-56e4-b7ea-72be66881b47', 'complete_chat', 'Диалог', '{"en":"Chat","ru":"Диалог"}'::jsonb, '{"answer_speaker":"You","dialogue":[{"speaker":"Liam","text":"What can you do?"}],"explanation":"“I can read and write” naturally describes your abilities.","instruction":"Ответьте.","options":[{"id":"WICD_L1_C_A","is_correct":true,"text":"I can read and write."},{"id":"WICD_L1_C_B","is_correct":false,"text":"I am from read."},{"id":"WICD_L1_C_C","is_correct":false,"text":"My name can."}]}'::jsonb, 12, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();
...
INSERT INTO courses.lessons (id, module_id, title, description, title_i18n, description_i18n, order_index, created_at, updated_at)
VALUES ('b2b721c9-87e7-5fb8-86b5-5aa85a2d6d30', NULL, 'Что я могу и не могу делать', 'Научиться говорить о том, что вы умеете и не умеете делать.', '{"en":"What I Can and Cannot Do","ru":"Что я могу и не могу делать"}'::jsonb, '{"en":"Learn to say what you can and cannot do.","ru":"Научиться говорить о том, что вы умеете и не умеете делать."}'::jsonb, 1, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET title = EXCLUDED.title, description = EXCLUDED.description, title_i18n = EXCLUDED.title_i18n, description_i18n = EXCLUDED.description_i18n, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('d04ac9c9-f21c-5bc9-b0b8-b275e393c138', 'b2b721c9-87e7-5fb8-86b5-5aa85a2d6d30', 'match_pairs', 'Соедините пары', '{"en":"Match the pairs","ru":"Соедините пары"}'::jsonb, '{"instruction":"Соедините английские слова с переводом.","pairs":[{"id":"WICD_L2_MP_P1","left":"can","right":"мочь, уметь"},{"id":"WICD_L2_MP_P2","left":"cannot","right":"не мочь, не уметь"},{"id":"WICD_L2_MP_P3","left":"play football","right":"играть в футбол"},{"id":"WICD_L2_MP_P4","left":"ride a bike","right":"кататься на велосипеде"},{"id":"WICD_L2_MP_P5","left":"cook","right":"готовить"},{"id":"WICD_L2_MP_P6","left":"use a computer","right":"пользоваться компьютером"},{"id":"WICD_L2_MP_P7","left":"play the piano","right":"играть на пианино"}]}'::jsonb, 0, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('ee4538e1-5b8e-58e2-b3d8-855b59d8a55b', 'b2b721c9-87e7-5fb8-86b5-5aa85a2d6d30', 'quiz', 'Проверьте себя', '{"en":"Check yourself","ru":"Проверьте себя"}'::jsonb, '{"explanation":"“I cannot cook” means that you do not have the ability to cook.","instruction":"Выберите правильный ответ.","options":[{"id":"WICD_L2_Q_A","is_correct":true,"text":"I cannot cook."},{"id":"WICD_L2_Q_B","is_correct":false,"text":"I can cook."},{"id":"WICD_L2_Q_C","is_correct":false,"text":"I like cooking."}],"question":"Which sentence says you do not have an ability?"}'::jsonb, 1, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('0ee243c8-1f95-5c5f-9641-924ee23f3aea', 'b2b721c9-87e7-5fb8-86b5-5aa85a2d6d30', 'translate', 'Переведите', '{"en":"Translate","ru":"Переведите"}'::jsonb, '{"correct_translation":"I cannot cook.","instruction":"Соберите перевод.","source_language":"ru","source_text":"Я не умею готовить.","target_language":"en","word_bank":["cook.","cannot","I"]}'::jsonb, 2, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('594c264f-a9bc-5f6d-aaf3-3a8f8766f281', 'b2b721c9-87e7-5fb8-86b5-5aa85a2d6d30', 'fill_blank', 'Заполните пропуск', '{"en":"Fill the blank","ru":"Заполните пропуск"}'::jsonb, '{"correct_answer":"can","instruction":"Выберите подходящее слово.","options":["can","am","from"],"sentence_template":"I ___ ride a bike."}'::jsonb, 3, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('afb6854c-7199-5331-8787-d08161af5227', 'b2b721c9-87e7-5fb8-86b5-5aa85a2d6d30', 'tap_words', 'Соберите фразу', '{"en":"Build the phrase","ru":"Соберите фразу"}'::jsonb, '{"correct_words":["I","cannot","play","football."],"instruction":"Расставьте слова в правильном порядке.","word_bank":["football.","cannot","play","I"]}'::jsonb, 4, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('61f1915c-eb3e-5ecb-a6a7-02c596e14c08', 'b2b721c9-87e7-5fb8-86b5-5aa85a2d6d30', 'listening', 'Послушайте', '{"en":"Listen","ru":"Послушайте"}'::jsonb, '{"audio_text":"I can ride a bike, but I cannot cook.","instruction":"Напишите услышанное.","language":"en"}'::jsonb, 5, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('8a9385c8-fa3c-580e-8753-e9ae16bce77b', 'b2b721c9-87e7-5fb8-86b5-5aa85a2d6d30', 'listening_shadowing', 'Повторите', '{"en":"Repeat","ru":"Повторите"}'::jsonb, '{"audio_text":"I can use a computer, but I cannot play the piano.","instruction":"Запишите повтор.","language":"en","min_accuracy":0.7,"translation_hint":"Я умею пользоваться компьютером, но не умею играть на пианино."}'::jsonb, 6, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('e3b81112-ba76-53c9-a3c3-39952a0649d1', 'b2b721c9-87e7-5fb8-86b5-5aa85a2d6d30', 'story', 'История', '{"en":"Story","ru":"История"}'::jsonb, '{"instruction":"Прочитайте историю.","scenes":[{"character":"Maya","text":"I can play football. Can you play?","translation":"Я умею играть в футбол. Ты умеешь играть?","type":"dialogue"},{"character":"Dan","text":"No, I cannot play football.","translation":"Нет, я не умею играть в футбол.","type":"dialogue"},{"options":[{"is_correct":true,"text":"But I can ride a bike."},{"is_correct":false,"text":"My bike is age."}],"text":"What can Dan say next?","type":"choice"}],"title":"After School"}'::jsonb, 7, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('68b90371-d03b-5070-b1c2-6a07de087852', 'b2b721c9-87e7-5fb8-86b5-5aa85a2d6d30', 'choose_definition', 'Определение', '{"en":"Definition","ru":"Определение"}'::jsonb, '{"explanation":"“Cook” means to prepare food.","instruction":"Выберите значение.","language":"en","options":[{"id":"WICD_L2_D_A","is_correct":true,"text":"To prepare food"},{"id":"WICD_L2_D_B","is_correct":false,"text":"To move through water"},{"id":"WICD_L2_D_C","is_correct":false,"text":"To make pictures with a pencil"}],"word":"cook"}'::jsonb, 8, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('63b0f6cd-5f79-566e-a059-f49f89bd68e7', 'b2b721c9-87e7-5fb8-86b5-5aa85a2d6d30', 'listen_choose_word', 'Слово', '{"en":"Word","ru":"Слово"}'::jsonb, '{"audio_text":"I cannot cook.","explanation":"The complete sentence is “I cannot cook.”","instruction":"Слушайте.","language":"en","options":[{"audio_text":"cook","id":"WICD_L2_LW_A","is_correct":true},{"audio_text":"country","id":"WICD_L2_LW_B","is_correct":false},{"audio_text":"name","id":"WICD_L2_LW_C","is_correct":false}],"sentence_template":"I cannot ___."}'::jsonb, 9, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('05ab86e7-74e6-5846-bad9-9f45a84aa57a', 'b2b721c9-87e7-5fb8-86b5-5aa85a2d6d30', 'missing_word', 'Впишите', '{"en":"Type","ru":"Впишите"}'::jsonb, '{"correct_answer":"cannot","explanation":"The complete sentence is “I cannot play the piano.”","hint_prefix":"can","instruction":"Впишите пропущенное слово по подсказке.","sentence_template":"I ___ play the piano."}'::jsonb, 10, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('10f72400-0bc6-5a29-a4f1-9c273d731007', 'b2b721c9-87e7-5fb8-86b5-5aa85a2d6d30', 'match_pairs_voice', 'Звук', '{"en":"Sound","ru":"Звук"}'::jsonb, '{"explanation":"Match each audio item with the same written English word or phrase.","instruction":"Соедините звук.","language":"en","pairs":[{"audio_text":"play football","id":"WICD_L2_VM_P1","text":"play football"},{"audio_text":"ride a bike","id":"WICD_L2_VM_P2","text":"ride a bike"},{"audio_text":"cook","id":"WICD_L2_VM_P3","text":"cook"}]}'::jsonb, 11, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('5453155a-e34b-5409-b77e-27feb3ece982', 'b2b721c9-87e7-5fb8-86b5-5aa85a2d6d30', 'complete_chat', 'Диалог', '{"en":"Chat","ru":"Диалог"}'::jsonb, '{"answer_speaker":"You","dialogue":[{"speaker":"Nora","text":"Can you ride a bike?"}],"explanation":"“Yes, I can” is a natural positive answer to a question with “Can you...?”","instruction":"Ответьте.","options":[{"id":"WICD_L2_C_A","is_correct":true,"text":"Yes, I can."},{"id":"WICD_L2_C_B","is_correct":false,"text":"Yes, I am bike."},{"id":"WICD_L2_C_C","is_correct":false,"text":"I live ride."}]}'::jsonb, 12, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();
...
INSERT INTO courses.lessons (id, module_id, title, description, title_i18n, description_i18n, order_index, created_at, updated_at)
VALUES ('fc069fe5-b48b-51ce-9b75-4c6efe228db7', NULL, 'Вопросы о способностях', 'Научиться спрашивать других об их способностях и давать короткие ответы.', '{"en":"Asking About Abilities","ru":"Вопросы о способностях"}'::jsonb, '{"en":"Learn to ask others about their abilities and give short answers.","ru":"Научиться спрашивать других об их способностях и давать короткие ответы."}'::jsonb, 2, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET title = EXCLUDED.title, description = EXCLUDED.description, title_i18n = EXCLUDED.title_i18n, description_i18n = EXCLUDED.description_i18n, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('1a459cb5-79ac-5647-aa6a-cb66588d7f3c', 'fc069fe5-b48b-51ce-9b75-4c6efe228db7', 'match_pairs', 'Соедините пары', '{"en":"Match the pairs","ru":"Соедините пары"}'::jsonb, '{"instruction":"Соедините английские слова с переводом.","pairs":[{"id":"WICD_L3_MP_P1","left":"Can you swim?","right":"Ты умеешь плавать?"},{"id":"WICD_L3_MP_P2","left":"Yes, I can","right":"Да, умею"},{"id":"WICD_L3_MP_P3","left":"No, I cannot","right":"Нет, не умею"},{"id":"WICD_L3_MP_P4","left":"Can she sing?","right":"Она умеет петь?"},{"id":"WICD_L3_MP_P5","left":"Can he draw?","right":"Он умеет рисовать?"},{"id":"WICD_L3_MP_P6","left":"very well","right":"очень хорошо"},{"id":"WICD_L3_MP_P7","left":"a little","right":"немного"}]}'::jsonb, 0, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('96f3c571-0ce5-5e14-98b6-0d89c868cad6', 'fc069fe5-b48b-51ce-9b75-4c6efe228db7', 'quiz', 'Проверьте себя', '{"en":"Check yourself","ru":"Проверьте себя"}'::jsonb, '{"explanation":"“Yes, I can” is the correct positive short answer.","instruction":"Выберите правильный ответ.","options":[{"id":"WICD_L3_Q_A","is_correct":true,"text":"Yes, I can."},{"id":"WICD_L3_Q_B","is_correct":false,"text":"Yes, I swim can."},{"id":"WICD_L3_Q_C","is_correct":false,"text":"Yes, I am."}],"question":"What is the correct short answer to “Can you swim?”"}'::jsonb, 1, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('58922ce3-5059-55f7-a362-c635a3c8799a', 'fc069fe5-b48b-51ce-9b75-4c6efe228db7', 'translate', 'Переведите', '{"en":"Translate","ru":"Переведите"}'::jsonb, '{"correct_translation":"Can you dance?","instruction":"Соберите перевод.","source_language":"ru","source_text":"Ты умеешь танцевать?","target_language":"en","word_bank":["dance?","you","Can"]}'::jsonb, 2, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('f6a80687-8e38-526b-ae40-244fd28e41fc', 'fc069fe5-b48b-51ce-9b75-4c6efe228db7', 'fill_blank', 'Заполните пропуск', '{"en":"Fill the blank","ru":"Заполните пропуск"}'::jsonb, '{"correct_answer":"swim","instruction":"Выберите подходящее слово.","options":["swim","old","city"],"sentence_template":"Can you ___?"}'::jsonb, 3, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('92b964a7-9b1b-50bd-8ed5-6a92c48f70c1', 'fc069fe5-b48b-51ce-9b75-4c6efe228db7', 'tap_words', 'Соберите фразу', '{"en":"Build the phrase","ru":"Соберите фразу"}'::jsonb, '{"correct_words":["Yes,","I","can."],"instruction":"Расставьте слова в правильном порядке.","word_bank":["can.","Yes,","I"]}'::jsonb, 4, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('a2b9124e-a8fc-5faf-805c-52c53f33bd11', 'fc069fe5-b48b-51ce-9b75-4c6efe228db7', 'listening', 'Послушайте', '{"en":"Listen","ru":"Послушайте"}'::jsonb, '{"audio_text":"Can you sing? Yes, I can.","instruction":"Напишите услышанное.","language":"en"}'::jsonb, 5, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('c80078e5-dd44-54c7-b4fb-820f1212ba2a', 'fc069fe5-b48b-51ce-9b75-4c6efe228db7', 'listening_shadowing', 'Повторите', '{"en":"Repeat","ru":"Повторите"}'::jsonb, '{"audio_text":"Can you draw? Yes, I can draw a little.","instruction":"Запишите повтор.","language":"en","min_accuracy":0.7,"translation_hint":"Ты умеешь рисовать? Да, я умею немного рисовать."}'::jsonb, 6, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('c8f68a98-d469-5ef6-a5d4-fcd0918ddb2a', 'fc069fe5-b48b-51ce-9b75-4c6efe228db7', 'story', 'История', '{"en":"Story","ru":"История"}'::jsonb, '{"instruction":"Прочитайте историю.","scenes":[{"character":"Sam","text":"Can you sing, Anna?","translation":"Анна, ты умеешь петь?","type":"dialogue"},{"character":"Anna","text":"Yes, I can sing very well.","translation":"Да, я умею очень хорошо петь.","type":"dialogue"},{"options":[{"is_correct":true,"text":"Can you play the piano?"},{"is_correct":false,"text":"Where old are you?"}],"text":"What should Anna ask Sam?","type":"choice"}],"title":"At the Music Club"}'::jsonb, 7, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('dcb94a95-9641-5ec8-ae2e-bf3009ae9024', 'fc069fe5-b48b-51ce-9b75-4c6efe228db7', 'choose_definition', 'Определение', '{"en":"Definition","ru":"Определение"}'::jsonb, '{"explanation":"“A little” means a small amount.","instruction":"Выберите значение.","language":"en","options":[{"id":"WICD_L3_D_A","is_correct":true,"text":"A small amount"},{"id":"WICD_L3_D_B","is_correct":false,"text":"A very great amount"},{"id":"WICD_L3_D_C","is_correct":false,"text":"Not at any time"}],"word":"a little"}'::jsonb, 8, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('d805828e-c913-546e-8dd7-3d4a0bfd01ab', 'fc069fe5-b48b-51ce-9b75-4c6efe228db7', 'listen_choose_word', 'Слово', '{"en":"Word","ru":"Слово"}'::jsonb, '{"audio_text":"Can you dance?","explanation":"The complete question is “Can you dance?”","instruction":"Слушайте.","language":"en","options":[{"audio_text":"dance","id":"WICD_L3_LW_A","is_correct":true},{"audio_text":"country","id":"WICD_L3_LW_B","is_correct":false},{"audio_text":"name","id":"WICD_L3_LW_C","is_correct":false}],"sentence_template":"Can you ___?"}'::jsonb, 9, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('c3effb0d-6cdc-5041-8b42-fc49669a9689', 'fc069fe5-b48b-51ce-9b75-4c6efe228db7', 'missing_word', 'Впишите', '{"en":"Type","ru":"Впишите"}'::jsonb, '{"correct_answer":"can","explanation":"The complete answer is “Yes, I can.”","hint_prefix":"ca","instruction":"Впишите пропущенное слово по подсказке.","sentence_template":"Yes, I ___."}'::jsonb, 10, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('3a9fba08-9a9f-5026-bd2d-cf42d3a39eb0', 'fc069fe5-b48b-51ce-9b75-4c6efe228db7', 'match_pairs_voice', 'Звук', '{"en":"Sound","ru":"Звук"}'::jsonb, '{"explanation":"Match each audio item with the same written English word or phrase.","instruction":"Соедините звук.","language":"en","pairs":[{"audio_text":"Can you swim?","id":"WICD_L3_VM_P1","text":"Can you swim?"},{"audio_text":"Yes, I can","id":"WICD_L3_VM_P2","text":"Yes, I can"},{"audio_text":"No, I cannot","id":"WICD_L3_VM_P3","text":"No, I cannot"}]}'::jsonb, 11, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('05783bf8-45cf-5940-aee7-d8cd77393d74', 'fc069fe5-b48b-51ce-9b75-4c6efe228db7', 'complete_chat', 'Диалог', '{"en":"Chat","ru":"Диалог"}'::jsonb, '{"answer_speaker":"You","dialogue":[{"speaker":"Olivia","text":"Can you play the piano?"}],"explanation":"“No, I cannot, but I can sing” answers the question and adds another ability.","instruction":"Ответьте.","options":[{"id":"WICD_L3_C_A","is_correct":true,"text":"No, I cannot, but I can sing."},{"id":"WICD_L3_C_B","is_correct":false,"text":"I am piano years old."},{"id":"WICD_L3_C_C","is_correct":false,"text":"My name is play."}]}'::jsonb, 12, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();
