...
VALUES ('77fffddd-1d4d-534e-be1e-e28e6a53397f', 'A1_TRAVEL_AT_THE_AIRPORT', 'В аэропорту', 'Научитесь регистрироваться на рейс, находить выход и понимать фразы при посадке.', 'en', 'A1', '', ARRAY['travel']::text[], true, 28, NOW(), NOW())
