...
VALUES ('b53b2373-7b96-5be4-9962-11b21f1aa639', 'A1_EXAM_SIMPLE_GRAMMAR_QUESTIONS', 'Простые задания по грамматике', 'Практикуйте глагол to be, Present Simple, вопросы и отрицания в простых экзаменационных заданиях.', '{"en":"Simple Grammar Questions","ru":"Простые задания по грамматике"}'::jsonb, '{"en":"Practise the verb to be, Present Simple, questions, and negatives in simple exam tasks.","ru":"Практикуйте глагол to be, Present Simple, вопросы и отрицания в простых экзаменационных заданиях."}'::jsonb, 'en', 'A1', '', ARRAY['exam']::text[], true, 117, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET title = EXCLUDED.title, description = EXCLUDED.description, title_i18n = EXCLUDED.title_i18n, description_i18n = EXCLUDED.description_i18n, motivation = EXCLUDED.motivation, is_published = EXCLUDED.is_published, sort_order = EXCLUDED.sort_order, updated_at = NOW();

INSERT INTO courses.lessons (id, module_id, title, description, title_i18n, description_i18n, order_index, created_at, updated_at)
VALUES ('3ead73cf-c3b9-5eba-a683-a0330ad22f1a', NULL, 'Глагол to be', 'Научиться выбирать am, is и are в простых экзаменационных заданиях.', '{"en":"The Verb To Be","ru":"Глагол to be"}'::jsonb, '{"en":"Learn to choose am, is, and are in simple exam tasks.","ru":"Научиться выбирать am, is и are в простых экзаменационных заданиях."}'::jsonb, 0, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET title = EXCLUDED.title, description = EXCLUDED.description, title_i18n = EXCLUDED.title_i18n, description_i18n = EXCLUDED.description_i18n, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('ccdf8e48-607b-5178-823c-e40c763e1c67', '3ead73cf-c3b9-5eba-a683-a0330ad22f1a', 'match_pairs', 'Соедините пары', '{"en":"Match the pairs","ru":"Соедините пары"}'::jsonb, '{"instruction":"Соедините английские слова с переводом.","pairs":[{"id":"ESGQ_L1_MP_P1","left":"I am","right":"я являюсь"},{"id":"ESGQ_L1_MP_P2","left":"you are","right":"ты являешься"},{"id":"ESGQ_L1_MP_P3","left":"he is","right":"он является"},{"id":"ESGQ_L1_MP_P4","left":"she is","right":"она является"},{"id":"ESGQ_L1_MP_P5","left":"it is","right":"это является"},{"id":"ESGQ_L1_MP_P6","left":"we are","right":"мы являемся"},{"id":"ESGQ_L1_MP_P7","left":"they are","right":"они являются"}]}'::jsonb, 0, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('ac041c87-5c27-5ca4-8eb9-feaf93fdf663', '3ead73cf-c3b9-5eba-a683-a0330ad22f1a', 'quiz', 'Проверьте себя', '{"en":"Check yourself","ru":"Проверьте себя"}'::jsonb, '{"explanation":"Use “is” with “she.”","instruction":"Выберите правильный ответ.","options":[{"id":"ESGQ_L1_Q_A","is_correct":true,"text":"She is a teacher."},{"id":"ESGQ_L1_Q_B","is_correct":false,"text":"She are a teacher."},{"id":"ESGQ_L1_Q_C","is_correct":false,"text":"She am a teacher."}],"question":"Choose the correct sentence."}'::jsonb, 1, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('00b1d584-050d-5665-9b1f-36170d8589be', '3ead73cf-c3b9-5eba-a683-a0330ad22f1a', 'translate', 'Переведите', '{"en":"Translate","ru":"Переведите"}'::jsonb, '{"correct_translation":"We are students.","instruction":"Соберите перевод.","source_language":"ru","source_text":"Мы ученики.","target_language":"en","word_bank":["students.","are","We"]}'::jsonb, 2, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('aae4506c-40c0-53dd-80a7-d90f52e3b3ca', '3ead73cf-c3b9-5eba-a683-a0330ad22f1a', 'fill_blank', 'Заполните пропуск', '{"en":"Fill the blank","ru":"Заполните пропуск"}'::jsonb, '{"correct_answer":"am","instruction":"Выберите подходящее слово.","options":["am","is","are"],"sentence_template":"I ___ happy."}'::jsonb, 3, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('5c1c241f-4935-5a75-ae8d-91e51d04e72f', '3ead73cf-c3b9-5eba-a683-a0330ad22f1a', 'tap_words', 'Соберите фразу', '{"en":"Build the phrase","ru":"Соберите фразу"}'::jsonb, '{"correct_words":["He","is","a","doctor."],"instruction":"Расставьте слова в правильном порядке.","word_bank":["a","is","doctor.","He"]}'::jsonb, 4, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('ee2add31-f7d6-5f67-82c2-f1fde868d7f0', '3ead73cf-c3b9-5eba-a683-a0330ad22f1a', 'listening', 'Послушайте', '{"en":"Listen","ru":"Послушайте"}'::jsonb, '{"audio_text":"They are at school.","instruction":"Напишите услышанное.","language":"en"}'::jsonb, 5, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('72813dfd-3b81-5ef1-9da7-a317f75a8441', '3ead73cf-c3b9-5eba-a683-a0330ad22f1a', 'listening_shadowing', 'Повторите', '{"en":"Repeat","ru":"Повторите"}'::jsonb, '{"audio_text":"I am Anna, and she is my teacher.","instruction":"Запишите повтор.","language":"en","min_accuracy":0.7,"translation_hint":"Я Анна, а она моя учительница."}'::jsonb, 6, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();
...
INSERT INTO courses.lessons (id, module_id, title, description, title_i18n, description_i18n, order_index, created_at, updated_at)
VALUES ('2f296d35-0771-5df3-a7c7-72afa5f9f1d5', NULL, 'Простое настоящее время', 'Научиться выбирать правильную форму глагола в простых предложениях Present Simple.', '{"en":"Present Simple","ru":"Простое настоящее время"}'::jsonb, '{"en":"Learn to choose the correct verb form in simple Present Simple sentences.","ru":"Научиться выбирать правильную форму глагола в простых предложениях Present Simple."}'::jsonb, 1, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET title = EXCLUDED.title, description = EXCLUDED.description, title_i18n = EXCLUDED.title_i18n, description_i18n = EXCLUDED.description_i18n, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('b913688f-55ae-5f2c-a950-d26e024413f8', '2f296d35-0771-5df3-a7c7-72afa5f9f1d5', 'match_pairs', 'Соедините пары', '{"en":"Match the pairs","ru":"Соедините пары"}'::jsonb, '{"instruction":"Соедините английские слова с переводом.","pairs":[{"id":"ESGQ_L2_MP_P1","left":"I work","right":"я работаю"},{"id":"ESGQ_L2_MP_P2","left":"you read","right":"ты читаешь"},{"id":"ESGQ_L2_MP_P3","left":"he works","right":"он работает"},{"id":"ESGQ_L2_MP_P4","left":"she reads","right":"она читает"},{"id":"ESGQ_L2_MP_P5","left":"we study","right":"мы учимся"},{"id":"ESGQ_L2_MP_P6","left":"they play","right":"они играют"},{"id":"ESGQ_L2_MP_P7","left":"every day","right":"каждый день"}]}'::jsonb, 0, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('10b00082-f689-5677-94b1-6e911c256126', '2f296d35-0771-5df3-a7c7-72afa5f9f1d5', 'quiz', 'Проверьте себя', '{"en":"Check yourself","ru":"Проверьте себя"}'::jsonb, '{"explanation":"Add “-s” to the verb with “he” in the Present Simple.","instruction":"Выберите правильный ответ.","options":[{"id":"ESGQ_L2_Q_A","is_correct":true,"text":"He works every day."},{"id":"ESGQ_L2_Q_B","is_correct":false,"text":"He work every day."},{"id":"ESGQ_L2_Q_C","is_correct":false,"text":"He working every day."}],"question":"Choose the correct sentence."}'::jsonb, 1, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('a09bd554-1f41-58ba-81f3-69ab1321fd90', '2f296d35-0771-5df3-a7c7-72afa5f9f1d5', 'translate', 'Переведите', '{"en":"Translate","ru":"Переведите"}'::jsonb, '{"correct_translation":"She reads every day.","instruction":"Соберите перевод.","source_language":"ru","source_text":"Она читает каждый день.","target_language":"en","word_bank":["day.","every","reads","She"]}'::jsonb, 2, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('f2904815-87f7-598c-847b-b81208dab8a9', '2f296d35-0771-5df3-a7c7-72afa5f9f1d5', 'fill_blank', 'Заполните пропуск', '{"en":"Fill the blank","ru":"Заполните пропуск"}'::jsonb, '{"correct_answer":"study","instruction":"Выберите подходящее слово.","options":["study","studies","is"],"sentence_template":"They ___ English."}'::jsonb, 3, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('8a428668-ef53-5f40-ad8a-db32c1d6afad', '2f296d35-0771-5df3-a7c7-72afa5f9f1d5', 'tap_words', 'Соберите фразу', '{"en":"Build the phrase","ru":"Соберите фразу"}'::jsonb, '{"correct_words":["He","plays","football."],"instruction":"Расставьте слова в правильном порядке.","word_bank":["football.","plays","He"]}'::jsonb, 4, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('bae85ae5-25dd-5cbe-b683-4fcd69b8da2b', '2f296d35-0771-5df3-a7c7-72afa5f9f1d5', 'listening', 'Послушайте', '{"en":"Listen","ru":"Послушайте"}'::jsonb, '{"audio_text":"We study English every day.","instruction":"Напишите услышанное.","language":"en"}'::jsonb, 5, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('556a2241-825b-5199-8872-90e833a528fd', '2f296d35-0771-5df3-a7c7-72afa5f9f1d5', 'listening_shadowing', 'Повторите', '{"en":"Repeat","ru":"Повторите"}'::jsonb, '{"audio_text":"She works at a school, and he works at a shop.","instruction":"Запишите повтор.","language":"en","min_accuracy":0.7,"translation_hint":"Она работает в школе, а он работает в магазине."}'::jsonb, 6, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('fa19e7d7-955e-55e8-8737-26c7f0c93f0a', '2f296d35-0771-5df3-a7c7-72afa5f9f1d5', 'story', 'История', '{"en":"Story","ru":"История"}'::jsonb, '{"instruction":"Прочитайте историю.","scenes":[{"character":"Teacher","text":"Complete: Anna ___ books.","translation":"Дополните: Анна ___ книги.","type":"dialogue"},{"character":"Student","text":"Reads.","translation":"Reads.","type":"dialogue"},{"options":[{"is_correct":true,"text":"Yes, Anna is “she.”"},{"is_correct":false,"text":"No, use “read” with she."}],"text":"Is “reads” correct?","type":"choice"}],"title":"Choose the Verb Form"}'::jsonb, 7, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('5804a111-1089-58e3-9b8f-d2220c997a5c', '2f296d35-0771-5df3-a7c7-72afa5f9f1d5', 'choose_definition', 'Определение', '{"en":"Definition","ru":"Определение"}'::jsonb, '{"explanation":"The Present Simple describes routines and regular facts.","instruction":"Выберите значение.","language":"en","options":[{"id":"ESGQ_L2_D_A","is_correct":true,"text":"A tense for routines and regular facts"},{"id":"ESGQ_L2_D_B","is_correct":false,"text":"A tense only for yesterday"},{"id":"ESGQ_L2_D_C","is_correct":false,"text":"A word that names a person"}],"word":"Present Simple"}'::jsonb, 8, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('3fb288e5-6e3d-5dfe-97ee-eb61ad99331d', '2f296d35-0771-5df3-a7c7-72afa5f9f1d5', 'listen_choose_word', 'Слово', '{"en":"Word","ru":"Слово"}'::jsonb, '{"audio_text":"He works at home.","explanation":"The missing form is “works.”","instruction":"Слушайте.","language":"en","options":[{"audio_text":"works","id":"ESGQ_L2_LW_A","is_correct":true},{"audio_text":"work","id":"ESGQ_L2_LW_B","is_correct":false},{"audio_text":"are","id":"ESGQ_L2_LW_C","is_correct":false}],"sentence_template":"He ___ at home."}'::jsonb, 9, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('78e96a1a-1799-53c8-9336-bc206c940aae', '2f296d35-0771-5df3-a7c7-72afa5f9f1d5', 'missing_word', 'Впишите', '{"en":"Type","ru":"Впишите"}'::jsonb, '{"correct_answer":"study","explanation":"The complete sentence is “We study English.”","hint_prefix":"st","instruction":"Впишите пропущенное слово по подсказке.","sentence_template":"We ___ English."}'::jsonb, 10, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('8f6e35bc-4b82-518f-8365-dc4daa55f9f4', '2f296d35-0771-5df3-a7c7-72afa5f9f1d5', 'match_pairs_voice', 'Звук', '{"en":"Sound","ru":"Звук"}'::jsonb, '{"explanation":"Match each item you hear with the same written English word or phrase.","instruction":"Соедините звук.","language":"en","pairs":[{"audio_text":"I work","id":"ESGQ_L2_VM_P1","text":"I work"},{"audio_text":"he works","id":"ESGQ_L2_VM_P2","text":"he works"},{"audio_text":"they play","id":"ESGQ_L2_VM_P3","text":"they play"}]}'::jsonb, 11, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('345c5f3e-bbd9-52dc-aa7f-008b145a2202', '2f296d35-0771-5df3-a7c7-72afa5f9f1d5', 'complete_chat', 'Диалог', '{"en":"Chat","ru":"Диалог"}'::jsonb, '{"answer_speaker":"You","dialogue":[{"speaker":"Teacher","text":"Choose: “She ___ music.”"}],"explanation":"Use “likes” with “she.”","instruction":"Ответьте.","options":[{"id":"ESGQ_L2_C_A","is_correct":true,"text":"Likes."},{"id":"ESGQ_L2_C_B","is_correct":false,"text":"Like."},{"id":"ESGQ_L2_C_C","is_correct":false,"text":"Are."}]}'::jsonb, 12, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();
...
INSERT INTO courses.lessons (id, module_id, title, description, title_i18n, description_i18n, order_index, created_at, updated_at)
VALUES ('6d403902-fbba-57c8-a672-789d5c70bf67', NULL, 'Простые вопросы и отрицания', 'Научиться узнавать простые вопросы и отрицательные предложения с do и does.', '{"en":"Simple Questions and Negatives","ru":"Простые вопросы и отрицания"}'::jsonb, '{"en":"Learn to recognize simple questions and negative sentences with do and does.","ru":"Научиться узнавать простые вопросы и отрицательные предложения с do и does."}'::jsonb, 2, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET title = EXCLUDED.title, description = EXCLUDED.description, title_i18n = EXCLUDED.title_i18n, description_i18n = EXCLUDED.description_i18n, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('8149279e-ac6e-568c-888a-b2be1cdc245c', '6d403902-fbba-57c8-a672-789d5c70bf67', 'match_pairs', 'Соедините пары', '{"en":"Match the pairs","ru":"Соедините пары"}'::jsonb, '{"instruction":"Соедините английские слова с переводом.","pairs":[{"id":"ESGQ_L3_MP_P1","left":"Do you work?","right":"Ты работаешь?"},{"id":"ESGQ_L3_MP_P2","left":"Does he study?","right":"Он учится?"},{"id":"ESGQ_L3_MP_P3","left":"I do not know","right":"Я не знаю"},{"id":"ESGQ_L3_MP_P4","left":"She does not work","right":"Она не работает"},{"id":"ESGQ_L3_MP_P5","left":"Yes, I do","right":"Да"},{"id":"ESGQ_L3_MP_P6","left":"No, he does not","right":"Нет"},{"id":"ESGQ_L3_MP_P7","left":"question","right":"вопрос"}]}'::jsonb, 0, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('1eb6e667-4e8e-5090-8c0f-2906b7bde13c', '6d403902-fbba-57c8-a672-789d5c70bf67', 'quiz', 'Проверьте себя', '{"en":"Check yourself","ru":"Проверьте себя"}'::jsonb, '{"explanation":"Use “does” with “she,” followed by the base verb “work.”","instruction":"Выберите правильный ответ.","options":[{"id":"ESGQ_L3_Q_A","is_correct":true,"text":"Does she work?"},{"id":"ESGQ_L3_Q_B","is_correct":false,"text":"Do she works?"},{"id":"ESGQ_L3_Q_C","is_correct":false,"text":"She does work?"}],"question":"Choose the correct question."}'::jsonb, 1, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('0584d237-dbb5-5051-a360-03e1c5a5dcda', '6d403902-fbba-57c8-a672-789d5c70bf67', 'translate', 'Переведите', '{"en":"Translate","ru":"Переведите"}'::jsonb, '{"correct_translation":"I do not work on Sunday.","instruction":"Соберите перевод.","source_language":"ru","source_text":"Я не работаю в воскресенье.","target_language":"en","word_bank":["Sunday.","on","work","not","do","I"]}'::jsonb, 2, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('baece7ea-28dc-5dc1-bd6a-742c31d040d6', '6d403902-fbba-57c8-a672-789d5c70bf67', 'fill_blank', 'Заполните пропуск', '{"en":"Fill the blank","ru":"Заполните пропуск"}'::jsonb, '{"correct_answer":"Does","instruction":"Выберите подходящее слово.","options":["Does","Do","Is"],"sentence_template":"___ he study English?"}'::jsonb, 3, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('00b02ca1-f0f3-50ad-b5ff-412e0b929ba1', '6d403902-fbba-57c8-a672-789d5c70bf67', 'tap_words', 'Соберите фразу', '{"en":"Build the phrase","ru":"Соберите фразу"}'::jsonb, '{"correct_words":["She","does","not","work."],"instruction":"Расставьте слова в правильном порядке.","word_bank":["not","She","work.","does"]}'::jsonb, 4, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('97ed27eb-53ed-5478-bb80-3acc347a4a67', '6d403902-fbba-57c8-a672-789d5c70bf67', 'listening', 'Послушайте', '{"en":"Listen","ru":"Послушайте"}'::jsonb, '{"audio_text":"Do you speak English?","instruction":"Напишите услышанное.","language":"en"}'::jsonb, 5, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('269938d1-acb8-5f34-9931-d598a98f2a48', '6d403902-fbba-57c8-a672-789d5c70bf67', 'listening_shadowing', 'Повторите', '{"en":"Repeat","ru":"Повторите"}'::jsonb, '{"audio_text":"Does he work here? No, he does not.","instruction":"Запишите повтор.","language":"en","min_accuracy":0.7,"translation_hint":"Он работает здесь? Нет."}'::jsonb, 6, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('767fe6fd-fe43-5d79-a9af-648e5cd821ba', '6d403902-fbba-57c8-a672-789d5c70bf67', 'story', 'История', '{"en":"Story","ru":"История"}'::jsonb, '{"instruction":"Прочитайте историю.","scenes":[{"character":"Teacher","text":"Choose: ___ Anna like music?","translation":"Выберите: ___ Анне нравится музыка?","type":"dialogue"},{"character":"Student","text":"Does.","translation":"Does.","type":"dialogue"},{"options":[{"is_correct":true,"text":"Yes, use “does” with Anna."},{"is_correct":false,"text":"No, use “are.”"}],"text":"Is the answer correct?","type":"choice"}],"title":"The Final Grammar Item"}'::jsonb, 7, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('5f533eca-d30c-5f02-a75e-058fa96a1668', '6d403902-fbba-57c8-a672-789d5c70bf67', 'choose_definition', 'Определение', '{"en":"Definition","ru":"Определение"}'::jsonb, '{"explanation":"A negative sentence says something is not true.","instruction":"Выберите значение.","language":"en","options":[{"id":"ESGQ_L3_D_A","is_correct":true,"text":"A sentence that says something is not true"},{"id":"ESGQ_L3_D_B","is_correct":false,"text":"A sentence that asks for information"},{"id":"ESGQ_L3_D_C","is_correct":false,"text":"A word that names an object"}],"word":"negative sentence"}'::jsonb, 8, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('e35aac01-cbc6-5085-a6d3-8497dbd6b2dd', '6d403902-fbba-57c8-a672-789d5c70bf67', 'listen_choose_word', 'Слово', '{"en":"Word","ru":"Слово"}'::jsonb, '{"audio_text":"Do you work here?","explanation":"Use “Do” with “you.”","instruction":"Слушайте.","language":"en","options":[{"audio_text":"Do","id":"ESGQ_L3_LW_A","is_correct":true},{"audio_text":"Does","id":"ESGQ_L3_LW_B","is_correct":false},{"audio_text":"Is","id":"ESGQ_L3_LW_C","is_correct":false}],"sentence_template":"___ you work here?"}'::jsonb, 9, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('222f0310-2af6-5217-9486-b48769b92a96', '6d403902-fbba-57c8-a672-789d5c70bf67', 'missing_word', 'Впишите', '{"en":"Type","ru":"Впишите"}'::jsonb, '{"correct_answer":"not","explanation":"The complete sentence is “He does not work here.”","hint_prefix":"no","instruction":"Впишите пропущенное слово по подсказке.","sentence_template":"He does ___ work here."}'::jsonb, 10, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('edbcc28c-615f-5d82-a9b7-732fe2e27b38', '6d403902-fbba-57c8-a672-789d5c70bf67', 'match_pairs_voice', 'Звук', '{"en":"Sound","ru":"Звук"}'::jsonb, '{"explanation":"Match each item you hear with the same written English word or phrase.","instruction":"Соедините звук.","language":"en","pairs":[{"audio_text":"Do you work?","id":"ESGQ_L3_VM_P1","text":"Do you work?"},{"audio_text":"Does he study?","id":"ESGQ_L3_VM_P2","text":"Does he study?"},{"audio_text":"I do not know","id":"ESGQ_L3_VM_P3","text":"I do not know"}]}'::jsonb, 11, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();

INSERT INTO courses.steps (id, lesson_id, type, title, title_i18n, content, order_index, created_at, updated_at)
VALUES ('b999ffb9-154f-5d29-8290-1f2db2f8f5c2', '6d403902-fbba-57c8-a672-789d5c70bf67', 'complete_chat', 'Диалог', '{"en":"Chat","ru":"Диалог"}'::jsonb, '{"answer_speaker":"You","dialogue":[{"speaker":"Teacher","text":"Choose: “___ they play football?”"}],"explanation":"Use “Do” with “they.”","instruction":"Ответьте.","options":[{"id":"ESGQ_L3_C_A","is_correct":true,"text":"Do."},{"id":"ESGQ_L3_C_B","is_correct":false,"text":"Does."},{"id":"ESGQ_L3_C_C","is_correct":false,"text":"Is."}]}'::jsonb, 12, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET type = EXCLUDED.type, title = EXCLUDED.title, title_i18n = EXCLUDED.title_i18n, content = EXCLUDED.content, order_index = EXCLUDED.order_index, updated_at = NOW();
